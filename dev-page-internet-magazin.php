...
<section class="section__wrap grayback pb-1 pb-sm-5" style="background-color:white">
	<div class="container">
		...
		<div class="col-sm-4">
                    ...
                    <span style="font-size:24px">01</span>Независимость продаж
                </span>
                    <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
                 Онлайн-магазин продает в любое время суток, вне зависимости от географии продавца и покупателя. Нет привязки к праздникам, выходным и графику работы кассира. Реализовывать продукцию можно на территории РФ или за ее пределами, если есть технические возможности. А если у покупателя возникли вопросы, он может обратиться к продавцу онлайн, через чат.
                    </span>
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">02</span>  Экономия средств и времени
                </span>
                    
                  <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
               Сокращается путь коммуникации и исключается человеческий фактор, нет риска неграмотной работы продавца. Покупатель заходит на сайт, сам выбирает понравившуюся позицию и заказывает ее, при необходимости запрашивает консультацию. Расходы сокращаются в разы.
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">03</span> Нет ограничений по типу и объему продукции
                </span>

                    
                  <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
                 Можно открыть магазинчик изделий ручной работы или запустить гипермаркет с поставками импортной продукции. Все зависит от амбиций заказчика и технических параметров CMS. Системы управления обладают серьезным потенциалом — сайт расширяется до нужных пределов.
                    </span>
               
            </div>
			<div class="col-sm-4" style="margin-top: 20px;">
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">04</span>Больший охват
                </span>

                    <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
                Оффлайновые точки гарантируют преимущественно приток тех покупателей, которые проживают рядом. После запуска онлайн-магазина все интернет-пользователи становятся потенциальными покупателями. Привлечь их можно, выведя сайт в топ поисковой выдачи при помощи СЕО-продвижения. Также компания может предложить более лояльные условия приобретения продукта или услуги. 
                    </span>
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">05</span>Обратная связь от аудитории
                </span>


                    
                    <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
              При помощи встроенной аналитики, отзывов, комментариев продавец может быстро фильтровать запросы и предпочтения покупателей. Становится проще тестировать новинки, уменьшать объем неликвидной продукции, отслеживать рост или падение популярности конкретных разделов или позиций.
                    </span>
    ...
    <div class="container">
        ...
        <div class="row qa-elem">
           ...
           Сколько стоит создание интернет-магазина?
            ...
            Стоимость зависит от выбора системы управления, сложности дизайна, размера ресурса. Окончательная цена формируется после этапа написания технического задания.
            </div>
        </div>
		<div class="row qa-elem">
            <div class="qa-title">
           Что входит в создание интернет-магазина? 
            ...
            <div class="qa-content">
           Подготовка (бриф, ТЗ), прототипирование, работа над дизайн-проектом, верстка. После верстки покупают лицензию и устанавливают CMS. Завершающий этап — тестирование, проверка на наличие ошибок и наполнение сайта контентом. 
            </div>
        </div>
		<div class="row qa-elem">
            <div class="qa-title">
            ...
            <div class="qa-content">
            Для получения результата от заказчика требуется полноценное сотрудничество. По запросу понадобится  предоставить данные о самом предприятии, рассказать об особенностях бизнес-процессов. 
            </div>
        </div>
        <div class="row qa-elem">
            <div class="qa-title">
          Сколько стоит интернет-магазин под ключ?
            </div>
            <div class="qa-content">
            Это зависит от сегмента и размера ресурса. Бюджетные предложения начинаются от нескольких десятков тысяч рублей, крупный онлайн-магазин может обойтись в сумму больше миллиона рублей. При самостоятельном наполнении площадки контентом можно сэкономить (если нет интеграции с базой данных).
            </div>
        </div>
