            ...
            <div class="row h-100">
                <div class="col-sm-12 d-flex justify-content-between align-items-center position-relative h-100">
                    ...
                    <div class="header__socials">
                        ...
                        <a href="https://api.whatsapp.com/send?phone=89995838586" target="_blank">
                    ...
                    <a href="tel:<?php echo do_shortcode('[city_phone]') ?>" class="header__tel">
                        ...
                        <svg class="d-sm-none d-md-block d-lg-none" fill="#2cb7ff" height="14px" width="14px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 473.806 473.806" xml:space="preserve">
                            <g>
                                <g>
