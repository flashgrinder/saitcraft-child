<?php
/*
Template Name: SEO-продвижение промышленных сайтов
*/
get_header();
?>
...
<span style="font-size:16px; color:#667399">SEO продвижение сайтов в этом случае выгоднее, чем таргетированная/контекстная реклама, поскольку раскручивать по отдельности каждую категорию дорого. Поисковая оптимизация позволяет вывести в топ выдачи весь каталог интернет-магазина, и бюджет при этом расходуется экономнее.
<br></span>
				</div>
				<h3 style="margin-bottom: 5px;"><span>
<svg width="28" height="21" viewBox="0 0 28 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<span style="font-size:16px; color:#667399">Суть стратегии продвижения новостных порталов — в частом обновлении контента. У таких ресурсов поисковые роботы индексируют новые страницы в течение нескольких часов.<br></span>
				</div>
				<h3 style="margin-bottom: 5px;"><span>
<svg width="28" height="21" viewBox="0 0 28 21" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M24.6666 3.33325L9.99992 17.9999L3.33325 11.3333" stroke="#00ADA8" stroke-width="4" stroke-linecap="square"/>
...
<section class="section__wrap grayback pb-1 pb-sm-5" style="background-color:white">
	<div class="container">
		...
		<div class="col-sm-12" style="text-align: center;">
                <h2>Особенности продвижения промышленных сайтов</h2>
            </div>
		<div class="col-sm-4">
                    ...
                    <span style="font-size:24px">01</span>Контент на сайте
                </span>
                    <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
                   Содержание сайта и контент должны быть понятны и узкому кругу профессионалов, и далёким от сложных технических процессов заказчикам.
                    </span>
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">02</span>Узконаправленный ассортимент
                </span>
                    
                  <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
               Ассортимент промышленных предприятий очень сложный и не пользуется массовым спросом. Поэтому лучшая стратегия здесь — это продвижение по тысячам низкочастотных запросов.
                    </span>
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">03</span>Информация о ценах
                </span>

                    
                  <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
                   Размещайте на сайте реальные и актуальные цены на товары. Поисковые алгоритмы используют эту информацию в ранжировании и показывают сайт выше в результатах поиска, что поможет увеличить количество лидов.
                    </span>
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    ...
                    <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
                 При сборе семантического ядра не упускайте даже самые низкочастотные запросы, чтобы не потерять потенциальных клиентов на этом этапе.
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">05</span>Структура страниц
                </span>


                    
                    <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
                  Чтобы повысить конверсию, структурируйте коммерческую информацию в виде таблиц, графиков или карточек товаров с ценами. Создавайте страницы опираясь на спрос пользователей, а не на логику владельца ресурса.
                    </span>
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">06</span>Анализ сайтов конкурентов
                </span>


                    
                    <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
                  Изучайте успешный и провальный опыт конкурентов. Используйте удачные фишки в своём продвижении — каждая из них может увеличить трафик.
                    </span>
...
<section class="slider__wrap slider__seo">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <h2>Этапы продвижения промышленного сайта</h2>
            </div>
            <div class="col-sm-12">
...
<section class="section__wrap grayback pb-1 pb-sm-5">
    <div class="container">
        ...
        <div class="row qa-elem">
            <div class="qa-title">
              Что включает в себя SEO-продвижение?
            </div>
            <div class="qa-content">
               SEO-продвижение — это не одна услуга, а целый комплекс мер, которые помогают повышать доверие поисковых систем Яндекс и Google к вашему сайту. В комплекс входит разработка посадочных страниц, подготовка текстов для сайта, сбор семантического ядра, кластеризация запросов, анализ трафика и многое другое — полный список работ зависит от ваших целей.
            </div>
        </div>
		<div class="row qa-elem">
            <div class="qa-title">
            ...
            <div class="qa-content">
            Стоимость зависит от вида продвижения: 
<ul>
	<li>по трафику, целевому посещению сайта;</li>
<li>по позициям, заранее намеченным поисковым запросам, которые выводят компанию в ТОП;</li>
<li>по целевым действиям, например, заявкам, кликам на корзину или звонкам;</li>
<li>через комплексный SEO-маркетинг.</li>
				</ul>
Средняя стоимость SEO-продвижения — от 60 000 рублей.

            </div>
        </div>
		<div class="row qa-elem">
            <div class="qa-title">
              Кому подойдёт SEO-продвижение?
            </div>
            <div class="qa-content">
             SEO-продвижение промышленного сайта актуально: 
				<ul>
					<li>фабрикам, заводам, холдингам или ИП, которые производят промышленные товары;</li>
<li>компаниям, которые оказывают промышленные услуги: проводят монтажные, ремонтные или проектные работы;</li>
<li>продавцам промышленного оборудования, деталей и комплектующих от производителей.</li>
				</ul>
            </div>
        </div>
        <div class="row qa-elem">
            <div class="qa-title">
              Как продвигать промышленное производство?
            </div>
            <div class="qa-content">
           Работа начинается с анализа конкурентов и разработки стратегии поисковой оптимизации. Для того чтобы правильно расставить акценты с учётом особенностей промышленной сферы, потребуется тесное сотрудничество между SEO-специалистом и клиентом. Первые результаты можно увидеть и оценить через 3–4  месяца.
            </div>
        </div>
