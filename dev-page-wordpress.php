...
<path d="M55.0002 19.3334H25.0002C24.5581 19.3334 24.1342 19.509 23.8217 19.8215C23.5091 20.1341 23.3335 20.558 23.3335 21V51C23.3335 51.4421 23.5091 51.866 23.8217 52.1786C24.1342 52.4911 24.5581 52.6667 25.0002 52.6667H55.0002C55.4422 52.6667 55.8661 52.4911 56.1787 52.1786C56.4912 51.866 56.6668 51.4421 56.6668 51V21C56.6668 20.558 56.4912 20.1341 56.1787 19.8215C55.8661 19.509 55.4422 19.3334 55.0002 19.3334ZM43.3335 49.3334H26.6668V37.6667H43.3335V49.3334ZM43.3335 34.3334H26.6668V22.6667H43.3335V34.3334ZM53.3335 49.3334H46.6668V22.6667H53.3335V49.3334Z" fill="white"/>
            ...
            <div class="col-sm-12 pb-5 d-flex justify-content-center justify-content-lg-start">
                <a href="javascript:;" class="button button--icon" data-stc-modal="#feedback-stc">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M23 12C23 18.0751 18.0751 23 12 23C10.2804 23 2 23 2 23C2 23 2 23 4.59717 20.1363C2.38713 18.1244 1 15.2242 1 12C1 5.92487 5.92487 1 12 1C18.0751 1 23 5.92487 23 12Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M13 14H9" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
...
<!-- <section class="dev__banner3 section__wrap">
    ...
    <div class="container">
        ...
        <div class="row qa-elem">
            ...
            Зависит от объема предоставляемых услуг, размера будущего веб-проекта. Чем больше страниц, функций, плагинов, тем выше будет стоимость.
            </div>
        </div>
		<div class="row qa-elem">
            <div class="qa-title">
             Что лучше: WP или Тильда? 
            </div>
            <div class="qa-content">
           У каждого решения свои плюсы и минусы. Тильда подходит для лендингов, типовых сайтов, в ситуации, когда важен не дизайн, а универсальность. WP был задуман как платформа для блогов, и оказался удачным вариантом для разработки интернет-магазинов, корпоративных сайтов, новостных порталов.
            </div>
        </div>
		<div class="row qa-elem">
            <div class="qa-title">
             Какие сайты можно сделать на WP? 
            </div>
            <div class="qa-content">
           Любые. Но на выбор CMS влияют цели и задачи, поставленные заказчиком. Многое зависит от планируемого функционала, закладываемого бюджета, типа сайта.
            </div>
        </div>
        <div class="row qa-elem">
            <div class="qa-title">
           Нужно ли платить за сайт на WP? 
            </div>
            <div class="qa-content">
           Нет, лицензия на платформу бесплатна и доступна всем желающим. Оплатить придется сервер, домен, работу специалистов, которые будут решать технические вопросы. По запросу клиента устанавливаются плагины, расширения, виджеты, сервисы, часть из которых также платная.
            </div>
        </div>
