<?php
/*
Template Name: SEO-продвижение Bitrix
*/
get_header();
?>
...
<section class="section__wrap grayback pb-1 pb-sm-5" style="background-color:white">
	<div class="container">
		...
		<div class="col-sm-12" style="text-align: center;">
                <h2>Какие типы сайтов на Bitrix можно продвигать</h2>
            </div>
		<div class="col-sm-4">
                    ...
                    <span style="font-size:24px">01</span>Промо-сайты
                </span>
                    <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
                 Сайт-портфолио демонстрирует выполненные работы, проекты, демонстрирующие профессионализм и опыт.
                    </span>
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">02</span>Блоги
                </span>
                    
                  <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
                  Блог, онлайн-дневник, применяют для размещения статей, новостей.
                    </span>
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">03</span>Корпоративные сайты
                </span>

                    
                  <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
                Корпоративный сайт компании представляет собой внешне ориентированный портал, многостраничник со сложной структурой, подробной информацией о деятельности, предназначенной для пользовательской аудитории, партнёров, прессы.
                    </span>
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">04</span>Интернет-магазины
                </span>

                    <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
                 Интернет-магазин предназначен для дистанционной продажи товаров.
                    </span>
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">05</span>Порталы
                </span>

                    <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
              Социальные сети, онлайн-платформы, создаются для многопрофильного общения, знакомств, контактов
                    </span>
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">06</span>Агрегаторы
                </span>

                    <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
              Маркетплейсы наделены значительными мощностями, работают торговой площадкой для товаров других компаний.
                    </span>
...
<div class="container">
    <div class="row">
        <div class="col-md-10" style="width:100%">
            <h2 style="text-align: center;">Особенности SEO-продвижения сайтов на Битриксе</h2>
...
<path d="M36.2197 49.4697L37.2803 50.5303L38.25 49.5605V50.75C38.25 51.1632 37.914 51.5 37.5 51.5H33C31.7595 51.5 30.75 52.5095 30.75 53.75V54.5758C29.0408 54.9245 27.75 56.4395 27.75 58.25C27.75 59.27 28.1618 60.194 28.8247 60.8705C26.8808 61.6407 25.5 63.5352 25.5 65.75V67.25C25.5 67.664 25.8353 68 26.25 68H36.75C37.1648 68 37.5 67.664 37.5 67.25V65.75C37.5 63.5352 36.1193 61.6407 34.1753 60.8705C34.8383 60.194 35.25 59.27 35.25 58.25C35.25 56.4395 33.9593 54.9245 32.25 54.5758V53.75C32.25 53.3368 32.586 53 33 53H37.5C38.7405 53 39.75 51.9905 39.75 50.75V49.5605L40.7197 50.5303L41.7803 49.4697L39.5303 47.2197C39.384 47.0735 39.192 47 39 47C38.808 47 38.616 47.0735 38.4697 47.2197L36.2197 49.4697ZM36 65.75V66.5H27V65.75C27 63.6823 28.6823 62 30.75 62H32.25C34.3177 62 36 63.6823 36 65.75ZM33.75 58.25C33.75 59.4905 32.7405 60.5 31.5 60.5C30.2595 60.5 29.25 59.4905 29.25 58.25C29.25 57.0095 30.2595 56 31.5 56C32.7405 56 33.75 57.0095 33.75 58.25Z" fill="white"/>
                ...
                Правильно сконфигурировать разделы и разделители URL
                    </span>
                    <span class="advantage__text1">
                 Необходимо использовать правильные настройки "ЧПУ", чтобы URL были удобными для пользователей и не были дубликатами других страниц.
                    </span>
</div>
                </div>
                <div class="advantage__item">
...
<path d="M49.5 53H51V54.5H49.5V53Z" fill="white"/>
                    ...
                    <div>
                    <span class="advantage__title1">
               Использовать множество возможностей SEO-модуля, входящего в комплект Битрикса
                    </span>
                    <span class="advantage__text1">
                 Установить заголовки, описания и ключевые слова, отслеживать уникальность контента, создавать файлы robots.txt и sitemap.xml, настраивать канонические ссылки и пр.
                    </span>
</div>
                </div>
                <div class="advantage__item">
...
<path d="M56.9978 50.0552C58.4812 50.0552 59.9312 49.6153 61.1646 48.7912C62.3979 47.9671 63.3592 46.7957 63.9269 45.4253C64.4946 44.0549 64.6431 42.5469 64.3537 41.092C64.0643 39.6371 63.35 38.3008 62.3011 37.2519C61.2522 36.203 59.9158 35.4887 58.461 35.1993C57.0061 34.9099 55.4981 35.0584 54.1277 35.6261C52.7572 36.1937 51.5859 37.155 50.7618 38.3884C49.9377 39.6218 49.4978 41.0718 49.4978 42.5552C49.5001 44.5436 50.291 46.45 51.697 47.856C53.103 49.262 55.0094 50.0529 56.9978 50.0552ZM56.9978 36.5552C58.1845 36.5552 59.3445 36.9071 60.3312 37.5664C61.3179 38.2256 62.087 39.1627 62.5411 40.2591C62.9952 41.3554 63.114 42.5618 62.8825 43.7257C62.651 44.8896 62.0796 45.9587 61.2404 46.7978C60.4013 47.6369 59.3322 48.2084 58.1683 48.4399C57.0045 48.6714 55.7981 48.5526 54.7017 48.0985C53.6053 47.6443 52.6683 46.8753 52.009 45.8886C51.3497 44.9019 50.9978 43.7419 50.9978 42.5552C50.9996 40.9644 51.6323 39.4394 52.7572 38.3145C53.882 37.1897 55.4071 36.557 56.9978 36.5552Z" fill="white"/>
                 ...
                 Оптимизация изображений
                    ...
                    <span class="advantage__text1">
               Оптимизировать изображения для ускорения загрузки страниц и приведения их в соответствие с требованиями SEO (название файлов, размеры, атрибуты alt и title).
                    </span>
</div>
                </div>
...
<path d="M56.9978 50.0552C58.4812 50.0552 59.9312 49.6153 61.1646 48.7912C62.3979 47.9671 63.3592 46.7957 63.9269 45.4253C64.4946 44.0549 64.6431 42.5469 64.3537 41.092C64.0643 39.6371 63.35 38.3008 62.3011 37.2519C61.2522 36.203 59.9158 35.4887 58.461 35.1993C57.0061 34.9099 55.4981 35.0584 54.1277 35.6261C52.7572 36.1937 51.5859 37.155 50.7618 38.3884C49.9377 39.6218 49.4978 41.0718 49.4978 42.5552C49.5001 44.5436 50.291 46.45 51.697 47.856C53.103 49.262 55.0094 50.0529 56.9978 50.0552ZM56.9978 36.5552C58.1845 36.5552 59.3445 36.9071 60.3312 37.5664C61.3179 38.2256 62.087 39.1627 62.5411 40.2591C62.9952 41.3554 63.114 42.5618 62.8825 43.7257C62.651 44.8896 62.0796 45.9587 61.2404 46.7978C60.4013 47.6369 59.3322 48.2084 58.1683 48.4399C57.0045 48.6714 55.7981 48.5526 54.7017 48.0985C53.6053 47.6443 52.6683 46.8753 52.009 45.8886C51.3497 44.9019 50.9978 43.7419 50.9978 42.5552C50.9996 40.9644 51.6323 39.4394 52.7572 38.3145C53.882 37.1897 55.4071 36.557 56.9978 36.5552Z" fill="white"/>
                  ...
                  Настройка внутренней перелинковки
                    ...
                    <span class="advantage__text1">
               Осуществлять внутреннюю перелинковку между страницами сайта, чтобы повысить их релевантность и удобство использования для посетителей.
                    </span>
</div>
                </div>
<div class="advantage__item">
...
<path d="M56.9978 50.0552C58.4812 50.0552 59.9312 49.6153 61.1646 48.7912C62.3979 47.9671 63.3592 46.7957 63.9269 45.4253C64.4946 44.0549 64.6431 42.5469 64.3537 41.092C64.0643 39.6371 63.35 38.3008 62.3011 37.2519C61.2522 36.203 59.9158 35.4887 58.461 35.1993C57.0061 34.9099 55.4981 35.0584 54.1277 35.6261C52.7572 36.1937 51.5859 37.155 50.7618 38.3884C49.9377 39.6218 49.4978 41.0718 49.4978 42.5552C49.5001 44.5436 50.291 46.45 51.697 47.856C53.103 49.262 55.0094 50.0529 56.9978 50.0552ZM56.9978 36.5552C58.1845 36.5552 59.3445 36.9071 60.3312 37.5664C61.3179 38.2256 62.087 39.1627 62.5411 40.2591C62.9952 41.3554 63.114 42.5618 62.8825 43.7257C62.651 44.8896 62.0796 45.9587 61.2404 46.7978C60.4013 47.6369 59.3322 48.2084 58.1683 48.4399C57.0045 48.6714 55.7981 48.5526 54.7017 48.0985C53.6053 47.6443 52.6683 46.8753 52.009 45.8886C51.3497 44.9019 50.9978 43.7419 50.9978 42.5552C50.9996 40.9644 51.6323 39.4394 52.7572 38.3145C53.882 37.1897 55.4071 36.557 56.9978 36.5552Z" fill="white"/>
                  ...
                  Оптимизация скорости загрузки сайта
                    ...
                    <span class="advantage__text1">
              Оптимизировать скорость работы сайта, удаляя лишние модули и скрипты, используя кэширование и сжатие картинок и файлов.
                    </span>
</div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row mb-0 mb-md-3">
            <div class="col-12 text-center">
                <h2>Преимущества SEO продвижения сайтов на Битрикс</h2>
            </div>
        </div>
        <div class="row mb-5">
            <div class="col-12 col-md-3 d-flex nandtitle">
                <span class="number__slide">1</span>
                <span class="title ms-3">Интеграция с Bitrix CMS</span>
            </div>
            <div class="col-12 col-md-9">
        SEO-оптимизация сайта на Bitrix проще и быстрее, так как платформа уже имеет встроенные инструменты для оптимизации.
            </div>            
        </div>
        <div class="row mb-5">
            <div class="col-12 col-md-3 d-flex nandtitle">
                <span class="number__slide">2</span>
                <span class="title ms-3">Удобный редактор контента</span>
            </div>
            <div class="col-12 col-md-9">
    Bitrix предлагает удобный редактор контента, который позволяет легко и быстро вносить изменения на сайте, оптимизировать заголовки, мета-теги и ключевые слова.
            </div>            
        </div>
        <div class="row mb-5">
            <div class="col-12 col-md-3 d-flex nandtitle">
                <span class="number__slide">3</span>
                <span class="title ms-3">Правильные URL-адреса</span>
            </div>
            <div class="col-12 col-md-9">
         Bitrix CMS автоматически генерирует оптимизированные URL-адреса для страниц сайта, что способствует улучшению поисковой оптимизации.
            </div>            
        </div>
		 <div class="row mb-5">
            <div class="col-12 col-md-3 d-flex nandtitle">
                <span class="number__slide">4</span>
                <span class="title ms-3">Аналитика и отчетность</span>
            </div>
            <div class="col-12 col-md-9">
     Bitrix предоставляет различные инструменты для анализа посещаемости сайта, ключевых слов и другой информации, необходимой для эффективной SEO-оптимизации.
            </div>            
        </div>
		<div class="row mb-5">
            <div class="col-12 col-md-3 d-flex nandtitle">
                <span class="number__slide">5</span>
                <span class="title ms-3">Мощный функционал</span>
            </div>
            <div class="col-12 col-md-9">
   Bitrix имеет множество возможностей для создания и организации контента, что помогает улучшить SEO-показатели сайта.
            </div>            
        </div>
		<div class="row mb-5">
            <div class="col-12 col-md-3 d-flex nandtitle">
                <span class="number__slide">6</span>
                <span class="title ms-3">Поддержка и обновления</span>
            </div>
            <div class="col-12 col-md-9">
  Bitrix предоставляет поддержку и регулярные обновления платформы, что обеспечивает безопасность и актуальность SEO-оптимизации сайта.
            </div>            
        </div>
    </div>
</section>
<section class="section__wrap grayback pb-1 pb-sm-5" style="background: #1A1E23 url(/img/team/2.svg);
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12" >
                <h2 style="color:white">Стоимость SEO продвижения сайтов на Bitrix</h2>
            </div>	
...
<section class="slider__wrap slider__seo">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <h2>Этапы продвижения сайта на Битриксе</h2>
            </div>
            <div class="col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="padding__content">
                                <ul class="checklist">
									<li>Проверяем установленную версию Bitrix, при необходимости обновляем до последней </li>
<li>Оптимизируем скорость работы</li>
<li>При необходимости настраиваем нужные интеграции с 1С или CRM</li>
<li>Проверяем сайт на вирусы, вредоносный код</li>
<li>Оптимизируем хостинг под работу сайта на Bitrix</li>
<li>Выполняем правильную настройку SEO модуля</li>
<li>Избавляемся от дублей страниц, метатегов</li>
<li>Настраиваем файл robots.txt исходя из особенностей сайтов на Битрикс</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-sm-6">
...
<section class="section__wrap grayback pb-1 pb-sm-5">
    <div class="container">
        ...
        <div class="row qa-elem">
            <div class="qa-title">
            Как оптимизировать сайт на Bitrix?
            </div>
            <div class="qa-content">
				<ol>
					<li>Установить кэширование и минимизировать количество запросов к базе данных </li>
 <li>Оптимизировать картинки с помощью сжатия и оптимизации размеров</li>
 <li>Использовать компрессию и gzip для сжатия передаваемых данных</li>
 <li>Размер страницы сайта должен быть максимум 2 мб</li>
 <li>Удалять неиспользуемые модули и компоненты</li>
				</ol>
            </div>
        </div>
		<div class="row qa-elem">
            <div class="qa-title">
              Сколько стоит сделать сайт на Битрикс?
            </div>
            <div class="qa-content">
         Расценки зависят от конкретных задач, тематики, вида веб-ресурса. Для быстрого запуска подойдёт готовое решение от 100 тысяч рублей плюс стоимость лицензии на программный продукт. Кроме создания ресурса, настройки, можно заказать техническую поддержку с перспективой улучшения.
            </div>
        </div>
		<div class="row qa-elem">
            <div class="qa-title">
            ...
            <div class="qa-content">
           Для продвижения сайта на Битрикс необходимо выполнить следующие шаги:
				<ol>
<li>Оптимизировать сайт под поисковые системы, например, настроить метатеги, заголовки, описание страниц.</li>
<li>Создать уникальный контент, который будет интересен посетителям сайта и приведет к повышению его рейтинга в поисковой выдаче.</li>
<li>Работать над увеличением количества ссылок на сайт извне, например, путем публикации гостевых постов на других сайтах или участия в совместных проектах с партнерами.</li>
	</ol>
            </div>
        </div>
