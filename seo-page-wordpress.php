<?php
/*
Template Name: SEO-продвижение Wordpress
*/
get_header();
?>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="point1 point__wrap">
                    ...
                    <span class="point__text">Целевой трафик и рост<br> количества первичных обращений</span>
                </div>
                <div class="point2 point__wrap">
                    <span class="point__number">02</span>
                    <span class="point__text">Повышение доверия<br> пользователей к бренду</span>
                </div>
                <div class="point3 point__wrap">
                    <span class="point__number">03</span>
                    <span class="point__text">Стоимость обращения в 3-5 раз ниже,<br>  чем с рекламы</span>
                </div>
                <div class="point4 point__wrap">
                    <span class="point__number">04</span>
                    <span class="point__text">Результат сохраняется<br> даже при остановке работ</span>
                </div>
            </div>
...
<section class="section__wrap grayback pb-1 pb-sm-5" style="background-color:white">
	<div class="container">
		...
		<div class="col-sm-12" style="text-align: center;">
                <h2>Какие типы сайтов на WordPress можно продвигать</h2>
            </div>
		<div class="col-sm-4">
                    ...
                    <span style="font-size:24px">01</span>Блоги
                </span>
                    <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
                  Блог может выступать как в качестве самостоятельной веб-единицы, так и входить в состав, например, интернет-магазина; контент блогов служит для получения органического трафика.
                    </span>
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">02</span>Корпоративные сайты
                </span>
                    
                  <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
                   Одностраничники сосредотачивают внимание посетителя на одном продукте или услуге; для лендинга часто задействуют специальные платные темы или плагины, расширяющие стандартный редактор до блочного, облегчающие построение.
                    </span>
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">03</span>Форумы
                </span>

                    
                  <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
                  Форум настроен на обсуждение заданных тем единомышленниками; среди множества плагинов-помощников часто запрашиваемый русифицированный BBPress.
                    </span>
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">04</span>Промо-сайты
                </span>

                    <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
                 Фотогалерея вмещает множество картинок, изображений, фотографий, поможет в работе художникам, дизайнерам, фотографам, работает прилично даже без дополнительных плагинов, покупка которых расширит функционал.
                    </span>
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">05</span>Сайты компаний
                </span>

                    <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
               Сайты компаний соединяют типы проектов в зависимости от назначения ресурса: лендинги, интернет-магазины, визитки. блоги, форумы, прочие.
                    </span>
...
<div class="container">
    <div class="row">
        <div class="col-md-10" style="width:100%">
            <h2 style="text-align: center;">Особенности SEO-продвижения сайтов на Wordpress</h2>
...
<path d="M36.2197 49.4697L37.2803 50.5303L38.25 49.5605V50.75C38.25 51.1632 37.914 51.5 37.5 51.5H33C31.7595 51.5 30.75 52.5095 30.75 53.75V54.5758C29.0408 54.9245 27.75 56.4395 27.75 58.25C27.75 59.27 28.1618 60.194 28.8247 60.8705C26.8808 61.6407 25.5 63.5352 25.5 65.75V67.25C25.5 67.664 25.8353 68 26.25 68H36.75C37.1648 68 37.5 67.664 37.5 67.25V65.75C37.5 63.5352 36.1193 61.6407 34.1753 60.8705C34.8383 60.194 35.25 59.27 35.25 58.25C35.25 56.4395 33.9593 54.9245 32.25 54.5758V53.75C32.25 53.3368 32.586 53 33 53H37.5C38.7405 53 39.75 51.9905 39.75 50.75V49.5605L40.7197 50.5303L41.7803 49.4697L39.5303 47.2197C39.384 47.0735 39.192 47 39 47C38.808 47 38.616 47.0735 38.4697 47.2197L36.2197 49.4697ZM36 65.75V66.5H27V65.75C27 63.6823 28.6823 62 30.75 62H32.25C34.3177 62 36 63.6823 36 65.75ZM33.75 58.25C33.75 59.4905 32.7405 60.5 31.5 60.5C30.2595 60.5 29.25 59.4905 29.25 58.25C29.25 57.0095 30.2595 56 31.5 56C32.7405 56 33.75 57.0095 33.75 58.25Z" fill="white"/>
                ...
                Удобство использования SEO-плагинов
                    </span>
                    <span class="advantage__text1">
                 Существует множество SEO-плагинов для WordPress, которые значительно упрощают оптимизацию сайта. Наиболее популярными являются Yoast SEO и All in One SEO Pack.
                    </span>
</div>
                </div>
                <div class="advantage__item">
...
<path d="M49.5 53H51V54.5H49.5V53Z" fill="white"/>
                 ...
                 Дружественность к поисковым системам
                    ...
                    <span class="advantage__text1">
                  WordPress имеет дружественную к поисковым системам структуру, позволяющую поисковым системам легко индексировать контент.
                    </span>
</div>
                </div>
                <div class="advantage__item">
...
<path d="M56.9978 50.0552C58.4812 50.0552 59.9312 49.6153 61.1646 48.7912C62.3979 47.9671 63.3592 46.7957 63.9269 45.4253C64.4946 44.0549 64.6431 42.5469 64.3537 41.092C64.0643 39.6371 63.35 38.3008 62.3011 37.2519C61.2522 36.203 59.9158 35.4887 58.461 35.1993C57.0061 34.9099 55.4981 35.0584 54.1277 35.6261C52.7572 36.1937 51.5859 37.155 50.7618 38.3884C49.9377 39.6218 49.4978 41.0718 49.4978 42.5552C49.5001 44.5436 50.291 46.45 51.697 47.856C53.103 49.262 55.0094 50.0529 56.9978 50.0552ZM56.9978 36.5552C58.1845 36.5552 59.3445 36.9071 60.3312 37.5664C61.3179 38.2256 62.087 39.1627 62.5411 40.2591C62.9952 41.3554 63.114 42.5618 62.8825 43.7257C62.651 44.8896 62.0796 45.9587 61.2404 46.7978C60.4013 47.6369 59.3322 48.2084 58.1683 48.4399C57.0045 48.6714 55.7981 48.5526 54.7017 48.0985C53.6053 47.6443 52.6683 46.8753 52.009 45.8886C51.3497 44.9019 50.9978 43.7419 50.9978 42.5552C50.9996 40.9644 51.6323 39.4394 52.7572 38.3145C53.882 37.1897 55.4071 36.557 56.9978 36.5552Z" fill="white"/>
                  ...
                  Использование тегов и категорий
                    ...
                    <span class="advantage__text1">
                 WordPress дает возможность использовать теги и категории для категоризации контента, что позволяет упростить пользователю поиск и повысить релевантность контента для поисковых систем.
                    </span>
</div>
                </div>
...
<path d="M56.9978 50.0552C58.4812 50.0552 59.9312 49.6153 61.1646 48.7912C62.3979 47.9671 63.3592 46.7957 63.9269 45.4253C64.4946 44.0549 64.6431 42.5469 64.3537 41.092C64.0643 39.6371 63.35 38.3008 62.3011 37.2519C61.2522 36.203 59.9158 35.4887 58.461 35.1993C57.0061 34.9099 55.4981 35.0584 54.1277 35.6261C52.7572 36.1937 51.5859 37.155 50.7618 38.3884C49.9377 39.6218 49.4978 41.0718 49.4978 42.5552C49.5001 44.5436 50.291 46.45 51.697 47.856C53.103 49.262 55.0094 50.0529 56.9978 50.0552ZM56.9978 36.5552C58.1845 36.5552 59.3445 36.9071 60.3312 37.5664C61.3179 38.2256 62.087 39.1627 62.5411 40.2591C62.9952 41.3554 63.114 42.5618 62.8825 43.7257C62.651 44.8896 62.0796 45.9587 61.2404 46.7978C60.4013 47.6369 59.3322 48.2084 58.1683 48.4399C57.0045 48.6714 55.7981 48.5526 54.7017 48.0985C53.6053 47.6443 52.6683 46.8753 52.009 45.8886C51.3497 44.9019 50.9978 43.7419 50.9978 42.5552C50.9996 40.9644 51.6323 39.4394 52.7572 38.3145C53.882 37.1897 55.4071 36.557 56.9978 36.5552Z" fill="white"/>
                    ...
                    <div>
                    <span class="advantage__title1">
                   Наличие чистой кодовой базы
                    </span>
                    <span class="advantage__text1">
                WordPress имеет чистую и семантически правильную кодовую базу, что способствует быстрой загрузке страниц и удобной навигации для пользователей и поисковых систем.
                    </span>
</div>
                </div>
<div class="advantage__item">
...
<path d="M56.9978 50.0552C58.4812 50.0552 59.9312 49.6153 61.1646 48.7912C62.3979 47.9671 63.3592 46.7957 63.9269 45.4253C64.4946 44.0549 64.6431 42.5469 64.3537 41.092C64.0643 39.6371 63.35 38.3008 62.3011 37.2519C61.2522 36.203 59.9158 35.4887 58.461 35.1993C57.0061 34.9099 55.4981 35.0584 54.1277 35.6261C52.7572 36.1937 51.5859 37.155 50.7618 38.3884C49.9377 39.6218 49.4978 41.0718 49.4978 42.5552C49.5001 44.5436 50.291 46.45 51.697 47.856C53.103 49.262 55.0094 50.0529 56.9978 50.0552ZM56.9978 36.5552C58.1845 36.5552 59.3445 36.9071 60.3312 37.5664C61.3179 38.2256 62.087 39.1627 62.5411 40.2591C62.9952 41.3554 63.114 42.5618 62.8825 43.7257C62.651 44.8896 62.0796 45.9587 61.2404 46.7978C60.4013 47.6369 59.3322 48.2084 58.1683 48.4399C57.0045 48.6714 55.7981 48.5526 54.7017 48.0985C53.6053 47.6443 52.6683 46.8753 52.009 45.8886C51.3497 44.9019 50.9978 43.7419 50.9978 42.5552C50.9996 40.9644 51.6323 39.4394 52.7572 38.3145C53.882 37.1897 55.4071 36.557 56.9978 36.5552Z" fill="white"/>
                    ...
                    <div>
                    <span class="advantage__title1">
                   Возможность создания SEO-оптимизированных URL-адресов
                    </span>
                    <span class="advantage__text1">
                WordPress позволяет создавать человекопонятные URL-адреса с помощью гибких настроек пермалинков.
                    </span>
</div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row mb-0 mb-md-3">
            <div class="col-12 text-center">
                <h2>Недостатки Wordpress</h2>
            </div>
        </div>
        <div class="row mb-5">
            <div class="col-12 col-md-3 d-flex nandtitle">
                <span class="number__slide">1</span>
                <span class="title ms-3">Вероятность взлома сайта</span>
            </div>
            <div class="col-12 col-md-9">
         Существует вероятность взлома сайта ввиду уязвимости CMS с открытым кодом, что повышает требования к безопасности.
            </div>            
        </div>
        <div class="row mb-5">
            <div class="col-12 col-md-3 d-flex nandtitle">
                <span class="number__slide">2</span>
                <span class="title ms-3">Нет технической поддержки</span>
            </div>
            <div class="col-12 col-md-9">
     Отсутствует официальная техническая поддержка, разрешить возникшую проблему можно обратившись к многочисленной, инициативной аудитории пользователей Wordpress на специальном форуме.
            </div>            
        </div>
        <div class="row mb-5">
            <div class="col-12 col-md-3 d-flex nandtitle">
                <span class="number__slide">3</span>
                <span class="title ms-3">CMS не предназначена для интернет-магазинов</span>
            </div>
            <div class="col-12 col-md-9">
          Wordpress изначально не предназначалась для создания интернет магазина, но при использовании бесплатного плагина Woocommerce разработчики гарантируют совместимость и полноценную работу; платные дополнения обеспечат полноценный функционал; при развёрнутом каталоге стоит реально оценить трудозатраты.
            </div>            
        </div>
		 <div class="row mb-5">
            <div class="col-12 col-md-3 d-flex nandtitle">
                <span class="number__slide">4</span>
                <span class="title ms-3">Частые ошибки при обновлении</span>
            </div>
            <div class="col-12 col-md-9">
      Могут возникнуть проблемы при обновлении, вытекающие из расширенной кастомизации: обновлённый плагин может привнести баги, вызывающие появление ошибок на странице. Обновленная WP иногда теряет совместимость с установленными дополнениями.
            </div>            
        </div>
		<div class="row mb-5">
            <div class="col-12 col-md-3 d-flex nandtitle">
                <span class="number__slide">5</span>
                <span class="title ms-3">Проблемы с производительностью</span>
            </div>
            <div class="col-12 col-md-9">
     Снижение производительности по причине большого количества установленных плагинов, которые необходимы для продвижения сайта в поисковиках, реализации коммерческих задач.
            </div>            
        </div>
    </div>
</section>
<section class="section__wrap grayback pb-1 pb-sm-5" style="background: #1A1E23 url(/img/team/2.svg);
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12" >
                <h2 style="color:white">Стоимость SEO продвижения сайтов на Wordpress</h2>
            </div>	
			<div style="margin-bottom: 40px">
				<span class="advantage__text1" style="color:white">
                   Точная сумма продвижения будет индивидуальна для каждого сайта. Она сильно зависит от конкуренции в нише и региона продвижения.<br><br>
...
<section class="slider__wrap slider__seo">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <h2>Этапы продвижения сайта на Wordpress</h2>
            </div>
            <div class="col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="padding__content">
                                <ul class="checklist">
									<li>Проверяем установленный шаблон, при необходимости вносим правки</li>
<li>Проверяем адаптивность сайта для мобильных устройств</li>
<li>Обновляем версию Wordpress при необходимости</li>
<li>Удаляем ненужные плагины и устанавливаем нужные</li>
<li>Проверяем сайт на вирусы, вредоносный код</li>
<li>Проверяем техническое состояние сайта</li>
<li>Избавляемся от дублей страниц, метатегов</li>
<li>Настраиваем файл robots.txt исходя из особенностей сайтов на Wordpress</li>
                ...
                <div class="tab-pane fade" id="pills-2" role="tabpanel" aria-labelledby="pills-2-tab">
                    <div class="row">
                        <div class="col-sm-6">
                            <h3><span>02</span>Аудит ниши проекта и аудитории</h3>
                            <div class="padding__content">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-6">
               ...
               После первичного анализа и базовой оптимизации вы увидите
первый результат — трафик начнет расти
                </span>
            </div>
            <div class="col-sm-6">
                <span class="seo__banner1-title">
			...
			<div class="col-sm-6">
                ...
                <span class="seo__banner1-text">
              Рост сайта станет стабильным, стоимость заявки с SEO будет дешевле, чем с рекламы
                </span>
            </div>
...
<li>Количество первичных записей из поиска с разбивкой по неделям</li>
<li>Стоимость одной записи</li>
<li>Количество первичных записей и стоимость</li>
...
<section class="section__wrap grayback pb-1 pb-sm-5">
    <div class="container">
        ...
        <div class="row qa-elem">
            <div class="qa-title">
            Сколько стоит СЕО продвижение сайта в месяц?
            </div>
            <div class="qa-content">
          Расчёт цены опирается на текущее состояние веб-ресурса, его специфику, конкурентную напряжённость, целевую направленность и проводится индивидуально для каждого конкретного случая.
            </div>
        </div>
		<div class="row qa-elem">
            <div class="qa-title">
               Что нужно сделать для продвижения сайта?
            </div>
            <div class="qa-content">
           Для SEO продвижения сайта необходимо выполнить следующие шаги:
<ol>
<li>Определить ключевые слова, на которые будет оптимизироваться сайт.
<li>Создать уникальный и качественный контент, содержащий ключевые слова.
<li>Оптимизировать мета-теги (заголовок, описание, ключевые слова) на каждой странице сайта.
<li>Создать адаптивную версию сайта для мобильных устройств.
<li>Регулярно обновлять контент на сайте и проводить анализ метрик сайта (трафик, отказы, время на сайте, конверсии) для оптимизации SEO стратегии. 
				</ol>
            </div>
        </div>
		<div class="row qa-elem">
            <div class="qa-title">
            Нужно ли платить за сайт на вордпресс?
            </div>
            <div class="qa-content">
            Сама CMS WordPress является бесплатной и доступна для скачивания и установки на свой хостинг. Однако, вы можете платить за различные платные темы и плагины, которые могут предоставлять дополнительные функции и возможности для вашего сайта.
            </div>
        </div>
        <div class="row qa-elem">
            <div class="qa-title">
            ...
            <div class="qa-content">
             Если вы не хотите заниматься самостоятельной установкой и настройкой сайта, вы можете обратиться к веб-студии или фрилансеру, который смогут создать сайт на WordPress за определенную плату. Цена зависит от многих факторов: установленной темы, плагинов, количества страниц, расширений для электронной коммерции. Разброс цен до полумиллиона рублей.
        ...
        <div class="row os-cards">
            <div class="col-sm-3 os-card">
                ...
                <div class="os-card-content">
                   Знаем все особенности продвижения интернет-магазинов. Привлечем качественный трафик и увеличим количество продаж
                </div>
                <div class="os-price">
                    от 60 000 ₽
                </div>
