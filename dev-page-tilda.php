...
<section class="section__wrap grayback pb-1 pb-sm-5" style="background-color:white">
	<div class="container">
		...
		<div class="col-sm-4">
                    ...
                    <span style="font-size:24px">01</span>Удобство работы
                </span>
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">02</span> Скорость разработки сайта
                </span>
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">03</span> Адаптивность
                </span>
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">04</span>Функциональный дизайн
                </span>
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">05</span>Собственная CRM система
                </span>
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">06</span>Интеграция со сторонними сервисами
                </span>
...
<section class="section__wrap pb-1 pb-sm-5 otlichie-yandex">
    <div class="container">
        ...
        <div class="row mb-5">
            ...
            <div class="col-12 col-md-9">
   Поскольку при создании проекта на Tilda код генерируется автоматически, в нем создается много лишнего «мусора», который и тормозит загрузку. При использовании на сайте изображений с большим разрешением и стороннего кода ситуация усугубляется. Технически программист может частично решить эту проблему.
            </div>            
        </div>
        <div class="row mb-5">
            <div class="col-12 col-md-3 d-flex nandtitle">
            ...
            <div class="col-12 col-md-9">
       Уже реализована возможность назначать готовую страницу шаблоном. Это облегчает разработку и сборку сайта на Tilda. Можно создать и сохранить свою собственную структуру, чтобы при необходимости пользоваться ею. 
            </div>            
        </div>
		 <div class="row mb-5">
            <div class="col-12 col-md-3 d-flex nandtitle">
            ...
            <div class="col-12 col-md-9">
    В отличие от WordPress, код на Тильде является закрытым, владелец не может его изменить. Но его можно просмотреть через DevTools, а на тарифе Business — экспортировать. Также владелец может добавлять собственный код, свои стили, тем самым меняя уже прописанную основу.
            </div>            
        </div>
		<div class="row mb-5">
            <div class="col-12 col-md-3 d-flex nandtitle">
            ...
            <div class="col-12 col-md-9">
   Несмотря на заложенную для СЕО базу, здесь все сложнее, чем в других CMS. Так, нельзя вручную настроить под свои нужды файл robots.txt. У некоторых СЕО-сервисов возникают сложности при анализе тильдовских сайтов. Но есть и плюсы: например, встроенный инструмент для поиска дублей и выявления ошибок в мета-тегах. 
            </div>            
        </div>
...
<!-- <section class="dev__banner3 section__wrap">
    ...
    <div class="container">
        ...
        <div class="row qa-elem">
            <div class="qa-title">
            В чем минусы конструктора Tilda?
            </div>
            <div class="qa-content">
           На конструкторе нельзя собрать серьезный проект из-за малого объема места на хостинга. Сложно настраивать интеграцию с 1С. Нет возможности корректировать код и часть СЕО-опций. Если сборщик сайта работает с зеро-блоками, ему придется самостоятельно адаптировать их под все разрешения экрана.
            </div>
        </div>
		<div class="row qa-elem">
            <div class="qa-title">
           Можно ли самому сделать сайт на Tilda? 
            ...
            <div class="qa-content">
          Разработчики конструктора предлагают бесплатно достаточный объем информации, уроков для создания веб-проектов на Tilda. Однако такой сайт будет отличаться по дизайну и функционалу от проекта, сделанного в веб-студии. Могут возникнуть сложности при внедрении стороннего кода. 
            </div>
        </div>
		<div class="row qa-elem">
            <div class="qa-title">
             Сколько стоит создать одностраничный сайт на Tilda? 
            </div>
            <div class="qa-content">
           Оплата за использование конструктора составляет от 500 до 1000 р/мес. Стоимость разработки самого сайта зависит от сложности дизайна и количества блоков. Окончательная цена рассчитывается после этапа прототипирования.
            </div>
        </div>
