<?php
/*
Template Name: SEO-продвижение по лидам
*/
get_header();
?>
...
<section class="section__wrap crm__page context__page-rows">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <h2>Кому подходит продвижение сайта по лидам</h2>
            </div>
        </div>
    </div>
    <div class="container">
...
</span>Сайтам услуг</h3>
<div style="margin-left: 55px; margin-bottom: 20px;">
	
				
<span style="font-size:16px; color:#667399">Организациям, которые относятся к сфере сервиса и услуг, фирмам, сдающим в аренду технику или авто, любым аналогичным компаниям, чьи услуги пользуются спросом в поисковых системах.
<br></span>
				</div>
				<h3 style="margin-bottom: 5px;"><span>
<svg width="28" height="21" viewBox="0 0 28 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<span style="font-size:16px; color:#667399"> Интернет-магазинам с широким ассортиментом, особенно предлагающим товары повседневного спроса. Как и в первом случае, у них большая целевая аудитория, что облегчает работу с трафиком.<br></span>
				</div>
				<h3 style="margin-bottom: 5px;"><span>
<svg width="28" height="21" viewBox="0 0 28 21" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M24.6666 3.33325L9.99992 17.9999L3.33325 11.3333" stroke="#00ADA8" stroke-width="4" stroke-linecap="square"/>
...
</span>Компаниям, реализующим дорогостоящие товары</h3>
<div style="margin-left: 55px; margin-bottom: 20px;">
	
				
<span style="font-size:16px; color:#667399"> Автомобили, люксовую мебель и технику, антиквариат, медицинское оборудование. Здесь продажа одного товара способна окупить цену лида и даже стоимость продвижения на несколько месяцев вперед.<br></span>
				</div>
				<h3 style="margin-bottom: 5px;"><span>
<svg width="28" height="21" viewBox="0 0 28 21" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M24.6666 3.33325L9.99992 17.9999L3.33325 11.3333" stroke="#00ADA8" stroke-width="4" stroke-linecap="square"/>
...
</span>Финансовым организациям</h3>
<div style="margin-left: 55px; margin-bottom: 20px;">
	
				
<span style="font-size:16px; color:#667399">Частным бухгалтериям, банкам, страховым агентствам, юридическим компаниям. Эта категория имеет возможность вложиться в продвижение сайта, чтобы получить отдачу в долгосрочной перспективе.<br></span>
				</div>
				<h3 style="margin-bottom: 5px;"><span>
<svg width="28" height="21" viewBox="0 0 28 21" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M24.6666 3.33325L9.99992 17.9999L3.33325 11.3333" stroke="#00ADA8" stroke-width="4" stroke-linecap="square"/>
...
</span>Развлекательным и информационным ресурсам</h3>
<div style="margin-left: 55px; margin-bottom: 20px;">
	
				
<span style="font-size:16px; color:#667399">Им чаще требуется не заявка, а подписка — действие, которое легко совершить пользователю.<br></span><br><br>
				</div>
			</div>
            ...
            <div class="col-sm-4 right-seo" >
                 <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <h2>Кому не подойдет<br> продвижение по лидам</h2>
                            </div>
                        </div>
                    </div>
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12" >
                                ...
                                </span>Бизнесу<br> с низким средним чеком</h3>
                                <div style="margin-left: 55px;">
                                    
                                                
                                <span style="font-size:16px; color:#667399">продвижение сайта через лиды не подойдет — кампания попросту не окупится.<br></span>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12" >
                                ...
                                </span>Проектам <br>с малым объемом продаж</h3>
                                <div style="margin-left: 55px;">
                                    
                                                
                                <span style="font-size:16px; color:#667399">как и в случае выше, продвижение может просто не окупиться.<br></span>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12" >
                                ...
                                </span>Молодым сайтам</h3>
                                <div style="margin-left: 55px;">
                                    
                                                
                                <span style="font-size:16px; color:#667399">у молодых сайтов будут сложности с определением конверсии и исходного уровня продаж<br></span>
                                </div>
                            </div>
                        </div>
                    </div>
...
<section class="seo__graph">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <h2>
               Что вы получите, выбирая <span>продвижение по лидам?</span>
                </h2>

                <div class="point1 point__wrap">
                    <span class="point__number">01</span>
                    <span class="point__text">Рост количества<br> целевых обращений</span>
                </div>
                <div class="point2 point__wrap">
                    <span class="point__number">02</span>
                    <span class="point__text">Увеличение<br> прибыли компании</span>
                </div>
                <div class="point3 point__wrap">
                    <span class="point__number">03</span>
                    <span class="point__text">Прозрачная система <br>прогресса и отчетности</span>
                </div>
                <div class="point4 point__wrap">
                    <span class="point__number">04</span>
                    <span class="point__text">Фиксированная<br> стоимость заявки</span>
                </div>
            </div>
...
<path d="M51.6663 19.3334H28.333C27.0069 19.3334 25.7352 19.8602 24.7975 20.7978C23.8598 21.7355 23.333 23.0073 23.333 24.3334V26.2834C23.3328 26.9716 23.4746 27.6525 23.7497 28.2834V28.3834C23.9851 28.9183 24.3187 29.4045 24.733 29.8167L34.9997 40.0167V51C34.9991 51.2833 35.0707 51.562 35.2078 51.8099C35.3449 52.0577 35.5428 52.2666 35.783 52.4167C36.0482 52.5811 36.3543 52.6677 36.6663 52.6667C36.9272 52.6651 37.1841 52.6023 37.4163 52.4834L44.083 49.15C44.3579 49.0115 44.589 48.7996 44.7508 48.5378C44.9126 48.276 44.9987 47.9745 44.9997 47.6667V40.0167L55.1997 29.8167C55.614 29.4045 55.9475 28.9183 56.183 28.3834V28.2834C56.481 27.6574 56.6456 26.9763 56.6663 26.2834V24.3334C56.6663 23.0073 56.1396 21.7355 55.2019 20.7978C54.2642 19.8602 52.9924 19.3334 51.6663 19.3334ZM42.1497 38.15C41.9952 38.3058 41.873 38.4905 41.7901 38.6935C41.7071 38.8966 41.6651 39.114 41.6663 39.3334V46.6334L38.333 48.3V39.3334C38.3343 39.114 38.2922 38.8966 38.2093 38.6935C38.1264 38.4905 38.0041 38.3058 37.8497 38.15L29.0163 29.3334H50.983L42.1497 38.15ZM53.333 26H26.6663V24.3334C26.6663 23.8913 26.8419 23.4674 27.1545 23.1549C27.4671 22.8423 27.891 22.6667 28.333 22.6667H51.6663C52.1084 22.6667 52.5323 22.8423 52.8449 23.1549C53.1574 23.4674 53.333 23.8913 53.333 24.3334V26Z" fill="white"/>
                ...
                <div class="advantage__card">
                    <span class="advantage__title">
                    Упор на качество лидов,<br> а не на их количество 
                    </span>
                    <span class="advantage__text">
...
<section class="section__wrap grayback pb-1 pb-sm-5" style="background-color:white">
	<div class="container">
		...
		<div class="col-sm-12" style="text-align: center;">
                <h2>Преимущества продвижения сайта по лидам</h2>
            </div>
		<div class="col-sm-4">
                    ...
                    <span style="font-size:24px">01</span> Фиксированная стоимость
                </span>
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">02</span>Безопасность
                </span>
                    
                  <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
                  При продвижении сайта по позициям заказчик сначала вкладывает деньги, а окупаются они только через несколько месяцев. При продвижении по лидам оплата взимается за реально привлеченных клиентов.
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">03</span>  Экономия для сезонного бизнеса
                </span>

                    
                  <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
                 В низкий сезон, когда просядут продажи, сократится и оплата за SEO-продвижение.
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">04</span> Прозрачность
                </span>


                    
                    <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
                  Заказчик сам выбирает целевые действия, за которые он будет платить. Все заявки, полученные без участия SEO-специалистов, из иных источников, не оплачиваются.
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">05</span>Оптимизация сайта
                </span>


                    
                    <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
               Основным работам предшествует тщательный аудит сайта, включающий технический аудит, юзабилити аудит, СЕО-анализ. Так, для интернет-магазина определяется не менее 30 показателей, которые могли быть не учтены при создании сайта.
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">06</span>Возможность планирования бюджета
                </span>


                    
                    <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
           Фиксированные расценки позволяют планировать расходы на продвижение сайта заранее, с учетом потенциального роста трафика.
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">07</span>Возможность быстро оценить эффективность
                </span>


                    
                    <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
             Уже после получения первых лидов заказчик рассчитывает окупаемость вложений и тем самым избегает лишних расходов.
...
<div class="container">
    <div class="row">
        <div class="col-md-10" style="width:100%">
            <h2 style="text-align: center;">Особенности продвижения сайта по лидам</h2>
...
<path d="M36.2197 49.4697L37.2803 50.5303L38.25 49.5605V50.75C38.25 51.1632 37.914 51.5 37.5 51.5H33C31.7595 51.5 30.75 52.5095 30.75 53.75V54.5758C29.0408 54.9245 27.75 56.4395 27.75 58.25C27.75 59.27 28.1618 60.194 28.8247 60.8705C26.8808 61.6407 25.5 63.5352 25.5 65.75V67.25C25.5 67.664 25.8353 68 26.25 68H36.75C37.1648 68 37.5 67.664 37.5 67.25V65.75C37.5 63.5352 36.1193 61.6407 34.1753 60.8705C34.8383 60.194 35.25 59.27 35.25 58.25C35.25 56.4395 33.9593 54.9245 32.25 54.5758V53.75C32.25 53.3368 32.586 53 33 53H37.5C38.7405 53 39.75 51.9905 39.75 50.75V49.5605L40.7197 50.5303L41.7803 49.4697L39.5303 47.2197C39.384 47.0735 39.192 47 39 47C38.808 47 38.616 47.0735 38.4697 47.2197L36.2197 49.4697ZM36 65.75V66.5H27V65.75C27 63.6823 28.6823 62 30.75 62H32.25C34.3177 62 36 63.6823 36 65.75ZM33.75 58.25C33.75 59.4905 32.7405 60.5 31.5 60.5C30.2595 60.5 29.25 59.4905 29.25 58.25C29.25 57.0095 30.2595 56 31.5 56C32.7405 56 33.75 57.0095 33.75 58.25Z" fill="white"/>
                   ...
                   Для интернет-магазина это может быть чат-бот, онлайн-консультант, для туристической фирмы — call tracking, для новостного ресурса — уникальный контент.
...
<path d="M49.5 53H51V54.5H49.5V53Z" fill="white"/>
                    ...
                    <div>
                    <span class="advantage__title1">
                   Совместная с заказчиком работа над проектом
                    </span>
                    <span class="advantage__text1">
                    Проводится аудит юзабилити сайта, уделяется внимание техническому аудиту, подключается веб-аналитика. Конверсия напрямую зависит от того, насколько сайт будет удобен для пользователя.
...
<path d="M56.9978 50.0552C58.4812 50.0552 59.9312 49.6153 61.1646 48.7912C62.3979 47.9671 63.3592 46.7957 63.9269 45.4253C64.4946 44.0549 64.6431 42.5469 64.3537 41.092C64.0643 39.6371 63.35 38.3008 62.3011 37.2519C61.2522 36.203 59.9158 35.4887 58.461 35.1993C57.0061 34.9099 55.4981 35.0584 54.1277 35.6261C52.7572 36.1937 51.5859 37.155 50.7618 38.3884C49.9377 39.6218 49.4978 41.0718 49.4978 42.5552C49.5001 44.5436 50.291 46.45 51.697 47.856C53.103 49.262 55.0094 50.0529 56.9978 50.0552ZM56.9978 36.5552C58.1845 36.5552 59.3445 36.9071 60.3312 37.5664C61.3179 38.2256 62.087 39.1627 62.5411 40.2591C62.9952 41.3554 63.114 42.5618 62.8825 43.7257C62.651 44.8896 62.0796 45.9587 61.2404 46.7978C60.4013 47.6369 59.3322 48.2084 58.1683 48.4399C57.0045 48.6714 55.7981 48.5526 54.7017 48.0985C53.6053 47.6443 52.6683 46.8753 52.009 45.8886C51.3497 44.9019 50.9978 43.7419 50.9978 42.5552C50.9996 40.9644 51.6323 39.4394 52.7572 38.3145C53.882 37.1897 55.4071 36.557 56.9978 36.5552Z" fill="white"/>
                    ...
                    <span class="advantage__text1">
                  Иногда сотрудники студии выходят за границы SEO-аудита и сбора семантического ядра. Они проводят анализ качества сервиса или работы интернет-магазина, дают рекомендации по ассортименту, чтобы привлеченные онлайн покупатели с большой вероятностью оставили заявку или приобрели товар.
...
<path d="M56.9978 50.0552C58.4812 50.0552 59.9312 49.6153 61.1646 48.7912C62.3979 47.9671 63.3592 46.7957 63.9269 45.4253C64.4946 44.0549 64.6431 42.5469 64.3537 41.092C64.0643 39.6371 63.35 38.3008 62.3011 37.2519C61.2522 36.203 59.9158 35.4887 58.461 35.1993C57.0061 34.9099 55.4981 35.0584 54.1277 35.6261C52.7572 36.1937 51.5859 37.155 50.7618 38.3884C49.9377 39.6218 49.4978 41.0718 49.4978 42.5552C49.5001 44.5436 50.291 46.45 51.697 47.856C53.103 49.262 55.0094 50.0529 56.9978 50.0552ZM56.9978 36.5552C58.1845 36.5552 59.3445 36.9071 60.3312 37.5664C61.3179 38.2256 62.087 39.1627 62.5411 40.2591C62.9952 41.3554 63.114 42.5618 62.8825 43.7257C62.651 44.8896 62.0796 45.9587 61.2404 46.7978C60.4013 47.6369 59.3322 48.2084 58.1683 48.4399C57.0045 48.6714 55.7981 48.5526 54.7017 48.0985C53.6053 47.6443 52.6683 46.8753 52.009 45.8886C51.3497 44.9019 50.9978 43.7419 50.9978 42.5552C50.9996 40.9644 51.6323 39.4394 52.7572 38.3145C53.882 37.1897 55.4071 36.557 56.9978 36.5552Z" fill="white"/>
                    ...
                    <span class="advantage__text1">
                Компании B2C через продвижение сайта по лидам могут получить постоянных клиентов. Эта экономическая выгода не всегда очевидна при оценке допустимой стоимости лида.
...
<section class="section__wrap pb-1 pb-sm-5" style="background: url(/img/po-lidam/1.svg), url(/img/po-lidam/2.svg);
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 text-center" >
                <h2>Тариф по лидам</h2>
            </div>	
			<div style="margin-bottom: 40px; color:#667399;" class="text-center">
				<span class="advantage__text1">
                  Стоимость одного лида просчитывается индивидуально для каждого проекта.<br><br>
					
Стоимость зависит от большого количества факторов: охват ниши и количество лидов, потенциал роста проекта, тематика, особенности аудитории, регион продвижения, стоимость продукта и т.д
                </span>
			</div>
            <div class="col-sm-12">
                <div class="">
                <table class="tarifs-table revert-color" style="">
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td class="mob-div-ta-c">
                            ...
                            <div class="mob-table-info"><b>Лиды</b></div> 
                        </td>
                        <td><b>Лиды</b></td>
                    </tr>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <span class="seo__banner1-title">
                    <span>01</span>Через 3 месяца
                </span>
                <span class="seo__banner1-text">
                Работа по привлечению лидов невозможна без глубокого анализа и проработки проекта, первые три месяца работы мы отводим на старт
                </span>
            </div>
            <div class="col-sm-6">
                <span class="seo__banner1-title">
                    <span>02</span>Через 6 месяцев
                </span>
                <span class="seo__banner1-text">
              К этому моменту проект выйдет на полную мощность, начнут поступать заявки
                </span>
            </div>
            <div class="col-sm-6">
                <span class="seo__banner1-title">
                    <br><span>03</span>Через 12 месяцев
                </span>
                <span class="seo__banner1-text">
              Благодаря регулярной работе с проектом количество либов будет расти от месяца к месяцу
                </span>
            </div>
            <div class="col-sm-6">
                <span class="seo__banner1-title">
                ...
                <span class="seo__banner1-text">
                Рост заявок станет стабильным, стоимость лида с SEO будет дешевле, чем с рекламы
                </span>
            </div>
...
<section class="slider__wrap slider__seo">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <h2>Этапы продвижения по лидам</h2>
            </div>
            <div class="col-sm-12">
...
сайта
                ...
                <li class="nav-item" role="presentation">
                    ...
                    <span class="number__slide">5</span>
                        <span class="text__slide">
                        Улучшение<br> поведенческих метрик
                        </span>
                    </button>
                </li>
                <li class="nav-item" role="presentation">
 ...
 <li>Формируем пользовательские сценарии</li>
 <li>Анализируем поведение клиентов на ресурсе</li>
 <li>Правим структуру при необходимости</li>
                ...
                <div class="tab-pane fade" id="pills-2" role="tabpanel" aria-labelledby="pills-2-tab">
                    <div class="row">
                        <div class="col-sm-6">
                            <h3><span>02</span>Настройка систем аналитики</h3>
                            <div class="padding__content">
                                <ul class="dots__opacity">
									<li>Подключаем или настраиваем необходимые системы статистики и аналитики</li> 
<li> Настраиваем call-tracking, электронную коммерцию</li> 
<li> Настраиваем цели в Яндекс.Метрике и/или Google Analytics</li> 
<li> Настройка CRM системы</li> 
<li> Проверяем корректность системы сбора заявок</li> 
								</ul>
                            </div>
                        </div>
                        <div class="col-sm-6">
                ...
                <div class="tab-pane fade" id="pills-3" role="tabpanel" aria-labelledby="pills-3-tab">
                    <div class="row">
                        <div class="col-sm-6">
                            <h3><span>03</span>Разработка стратегии</h3>
                            <div class="padding__content">
                                <ul class="dots__opacity">
...
<li>Анализ конверсионности семантики</li>
                ...
                <div class="tab-pane fade" id="pills-5" role="tabpanel" aria-labelledby="pills-5-tab">
                    <div class="row">
                        <div class="col-sm-6">
                            <h3><span>05</span>Улучшение поведенческих метрик</h3>
                            <div class="padding__content">
                                <ul class="dots__opacity">
									<li> Реализуем юзабилити-аудит </li>
<li>Выявляем уязвимые места и улучшаем функциональность </li>
<li>Проверяем и настраиваем работу корзины, форм обратной связи</li>
<li>Устраняем ошибки в мобильной версии сайта</li>
<li>Анализ и изменение навигации по сайту</li>
<li>Тестирование гипотез по росту конверсионности</li>
...
<li>Размещаем предложения на спецпорталах и торговых площадках в соответствии с планом</li>
				   ...
				   <div class="tab-pane fade" id="pills-7" role="tabpanel" aria-labelledby="pills-7-tab">
                    <div class="row">
                        <div class="col-sm-6">
                            <h3><span>07</span>Лидогенерация</h3>
                            <div class="padding__content">
                                <ul class="dots__opacity">
									<li> Анализ обращений на сайт, отсеиваем нецелевые заявки</li>
<li>Прослушиваем и анализируем телефонные звонки от клиентов</li>
<li>Внедряем новые конверсионные элементы</li>
<li>Составляем срезы и отчеты по проделанной работе</li>
				 ...
				 <div class="tab-pane fade" id="pills-8" role="tabpanel" aria-labelledby="pills-8-tab">
                    <div class="row">
                        <div class="col-sm-6">
                            <h3><span>08</span>Анализ результатов и доработки сайта</h3>
                            <div class="padding__content">
                                <ul class="dots__opacity">
									<li>  Анализируем и выявляем проблемные страницы, продукты </li>
...
<section class="section__wrap crm__page crm__page_kak context__page-rows">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
...
</span>Отчёт по обращениям и продажам</h3>
                <ul class="graydot">
	...
	<script type="application/ld+json">
{
  ...
  "@type": "Product", 
  "name": "SEO-продвижение сайта по лидам",
    ...
    <div class="container">
        ...
        <div class="row qa-elem">
            ...
            <div class="qa-content">
              При продвижении сайта под лидами понимают потенциальных клиентов, проявивших интерес к услуге или товару и оставивших свои контактные данные — аккаунт в мессенджере, e-mail, номер телефона.
            </div>
        </div>
		<div class="row qa-elem">
            <div class="qa-title">
            ...
            <div class="qa-content">
              Это акт регистрации, который пользователь совершает в ответ на рекламное предложение. Например, оставляет свои контакты, отвечая на запрос чат-бота интернет-магазина. Указанный контакт в дальнейшем используется в маркетинговой воронке.
            </div>
        </div>
		<div class="row qa-elem">
            <div class="qa-title">
               Что такое лиды в продаже?
            </div>
            <div class="qa-content">
               Это клиент, который способен совершить покупку. К лидам в продажах относятся всевозможные виды обращений — письма на электронную почту, заявки в соцсетях, мессенджерах, на сайте, заказ обратного звонка и пр. Они обрабатываются и фильтруются на нецелевые и целевые.
            </div>
        </div>
        <div class="row qa-elem">
            <div class="qa-title">
                Возможно ли продвижение по лидам без подключения коллтрекинга?
            </div>
            <div class="qa-content">
               Без отслеживания статистики сложно оценить эффективность продвижения сайта и поисковый трафик. Это затруднит работу по подбору запросов и улучшению видимости сайта в поисковых системах.
