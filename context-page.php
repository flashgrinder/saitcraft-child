...
<section class="section__wrap pb-1 pb-sm-5 otlichie-yandex">
    <div class="container">
        ...
        <div class="row mb-5">
          ...
          Настройка рекламных объявлений начинается с анализа рынка, ниши бизнеса, конкурентов и целевой аудитории в Яндекс Директе и Google Ads.
            </div>            
        </div>
        <div class="row mb-5">
            <div class="col-12 col-md-3 d-flex nandtitle">
            ...
            <div class="col-12 col-md-9">
         Затем формируется стратегия рекламной кампании и оцифровываются цели для расчёта бюджета. Команда агентства составляет расширенное семантическое ядро, удаляя нецелевые фразы и клики. 
            </div>            
        </div>
        <div class="row mb-5">
            <div class="col-12 col-md-3 d-flex nandtitle">
            ...
            <div class="col-12 col-md-9">
             После рекламные кампании разделяются на подкатегории, прорабатываются объявления и размещаются UTM-метки.
            </div>            
        </div>
		<div class="row mb-5">
            <div class="col-12 col-md-3 d-flex nandtitle">
            ...
            <div class="col-12 col-md-9">
            Только по результатам всех подготовительных работ начинается настройка рекламной кампании и объявления запускаются на поиске и на сайтах-партнёрах. Если пройти все этапы и тщательно проработать контекстную рекламу, результат и рост продаж не заставит ждать.
            </div>            
        </div>
        ...
        <div class="tab tab-2 active">
			 <div class="row mb-5">
                <div class="col-12 col-md-6 d-flex elem pe-md-5 mb-5 mb-md-0">
                    ...
                    <div class="ps-5 ps-md-3 col-11 d-flex flex-wrap">
                      <a href="/uslugi/kontekstnaya-reklama/google/">  <div class="title">
                          Контекстная реклама в Google Ads
						  </div> </a>
                        <div class="descr">
                Сервис контекстной рекламы в поисковой системе Google. Принципы размещения в Яндекс Директ и Google Ads схожи: объявление размещается в поисковой выдаче и на сайтах-партнерах Google.
                        </div>
                        <a href="/uslugi/kontekstnaya-reklama/google/"> <div class="right-arrow">
                ...
                <div class="col-12 col-md-6 d-flex elem ps-md-5">
                    ...
                    <div class="ps-5 ps-md-3 col-11 d-flex flex-wrap">
                       <a href="/uslugi/kontekstnaya-reklama/yandex/"> <div class="title">
                            Контекстная реклама в Яндекс Директ
						   </div> </a>
                        <div class="descr">   
                 Это российский сервис контекстной рекламы. Рекламное объявление транслируется в поисковой выдаче и в Рекламной сети Яндекса. РСЯ рассчитана на «прохладную» аудиторию, поэтому коэффициент кликабельности может быть ниже, чем в рекламе на поиске, которая отвечает на точный запрос пользователя. 
                        </div>
                     <a href="/uslugi/kontekstnaya-reklama/yandex/"> <div class="right-arrow">
                            <svg width="24" height="10" viewBox="0 0 24 10" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M19 1L23 5M23 5L19 9M23 5H1" stroke="#7F6CE0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/> </svg>
						  </div> </a>
                    </div>
                </div>
            ...
            <div class="row mb-5">
                ...
                <div class="col-12 col-md-6 d-flex elem pe-md-5 mb-5 mb-md-0">
                    ...
                    <div class="ps-5 ps-md-3 col-11 d-flex flex-wrap">
                     <a href="/uslugi/kontekstnaya-reklama/audit/">   <div class="title">
                            Аудит рекламной кампании
						 </div> </a>
                        <div class="descr">
                           Это независимая и точная оценка запущенных кампаний, которая поможет определить слабые места и найти способы корректировки и оптимизации. Аудит, в отличие от анализа, проводится комплексно в разрезе сквозной аналитики, которая отслеживает путь клиента от первого клика до заявки, покупки и вероятности повторных обращений.
                        </div>
                     <a href="/uslugi/kontekstnaya-reklama/audit/">   <div class="right-arrow">
                            <svg width="24" height="10" viewBox="0 0 24 10" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M19 1L23 5M23 5L19 9M23 5H1" stroke="#7F6CE0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/> </svg>
						 </div> </a>
                    </div>
                </div>
               <div class="col-12 col-md-6 d-flex elem pe-md-5 mb-5 mb-md-0">
                    ...
                    <div class="ps-5 ps-md-3 col-11 d-flex flex-wrap">
                     <a href="/uslugi/kontekstnaya-reklama/audit/">   <div class="title">
                        ...
                        <div class="descr">
                          Это реклама на конкретный, узкий сегмент целевой аудитории. Кампания настраивается с учётом высокоточных характеристик: интересов, проблем и потребностей пользователей, их активности и поведении в интернете, местоположении или местам, которые они часто посещают. 
                        </div>
                     <a href="/uslugi/kontekstnaya-reklama/audit/">   <div class="right-arrow">
                            <svg width="24" height="10" viewBox="0 0 24 10" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M19 1L23 5M23 5L19 9M23 5H1" stroke="#7F6CE0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/> </svg>
						 </div> </a>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="padding__content">
                                <ul class="checklist">
									...
									<li>Настраиваем инструменты для сбора статистики и оценки эффективности рекламы</li>
                ...
                <div class="tab-pane fade" id="pills-5" role="tabpanel" aria-labelledby="pills-5-tab">
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="padding__content">
                                <ul class="checklist">
                                    <li>Выделяем ваши конкурентные преимущества в УТП для отстройки от конкурентов</li>
...
(быстрые ссылки, уточнения, контакты и пр.)</li>
...
<section class="section__wrap grayback pb-1 pb-sm-5">
    <div class="container">
		...
		<div class="row qa-elem">
            ...
            <div class="qa-content">
             SEO направлено в первую очередь на улучшение содержания сайта. Контент на сайте оптимизируется с помощью ключевых фраз, чтобы надолго повысить рейтинг в поисковой выдаче. Контекстная реклама работает только пока запущена, но приводит более «тёплую» и заинтересованную в покупке аудиторию. Оба способа эффективны, но в тандеме работают только лучше. 
            </div>
        </div>
		<div class="row qa-elem">
            <div class="qa-title">
           Как работает контекстная реклама простыми словами?
            ...
            <div class="qa-content">
             Интернет-реклама показывается в поисковой выдаче и на сайтах-партнёрах, чья ниша схожа с рекламируемым продуктом. Пользователь вводит запрос в строку поиска, а алгоритмы показывают объявления, релевантные его вопросу.
            </div>
        </div>
        <div class="row qa-elem">
            <div class="qa-title">
            ...
            <div class="qa-content">
             Стоимость определяется масштабом бизнеса, продолжительностью демонстрации, уровнем конкуренции и местом размещения. Для разной целевой аудитории подходят соответствующие товары и услуги, а также подача информации, что тоже влияет на цену.
            </div>
        </div>
            ...
            <div class="qa-content">
             Качество настройки контекстной рекламы проверяют сверяя поисковые запросы с заголовками объявлений и посадочных страниц, контролируя группировку ключей по отдельным сегментам целевой аудитории, разделение компаний по направлениям продвижения, географическому таргетингу и многому другому. Эффективность рекламных кампаний в конечном счете определяется количеством заявок и их ценой.
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="os-cards">
            ...
            <div class="col-sm-3 os-card">
                ...
                <div class="os-card-content">
                 Контекстная реклама в Google Ads показывается в результатах поиска Google и на сайтах партнеров Google, которые входят в контекстно-медийную сеть Google (КМС).
                </div>
                <div class="os-price">
                    от 60 000 ₽
                </div>
