	...
	<div class="table-cost__body container">
		...
		<div class="table-cost__table">
			...
			<div class="table-cost__row">
				...
				<div class="table-cost__check table-cost__check--text text text--pre-large text--white text--w-light text--uppercase">
		...
		<div class="row">
			...
			<div class="col-12 col-md-5 m-auto text-center">
				<div class="team-circle">
					<img data-src="/img/team/circle.svg" class="js-lazyload circle-svg" style="opacity:0" alt="circle-svg" />
					<img data-src="/img/team/Tanya.png" class="js-lazyload team-img" style="opacity:0" alt="Татьяна" />
				</div>
			</div>
		</div>
	</div>
