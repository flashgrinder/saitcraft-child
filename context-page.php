...
?>
	...
	<section class="search-promotion bg--dark b-padding-100">
		<div class="search-promotion__body container">
			<h2 class="search-promotion__heading title title--big title--white title--w-extra-bold title--indent"
			    data-num="+">
				Кому <span class="search-promotion__heading-accent title title--purple">подойдет</span> контекстная
				реклама
			</h2>
			<div class="search-promotion__items">
				<div class="search-promotion__item">
					<div class="search-promotion__info">
						...
						<div class="search-promotion__text title title--big-medium title--white title--w-light">
							Фотографам, дизайнерам, мастерам ногтевого сервиса, косметологам, мастерам ремонта и другим
							ИП, которые предоставляют свои услуги
						</div>
					</div>
				</div>
				<div class="search-promotion__item">
					<div class="search-promotion__info">
						...
						<div class="search-promotion__text title title--big-medium title--white title--w-light">
							Ниша и сфера бизнеса чаще не имеют значения — контекстная реклама найдёт вашу целевую
							аудиторию
						</div>
					</div>
				</div>
				...
				<div class="search-promotion__item">
					<div class="search-promotion__info">
						...
						<div class="search-promotion__text title title--big-medium title--white title--w-light">
							Контекстную рекламу увидят только заинтересованные пользователи, даже если сфера очень
							ограничена, а спрос низкий
						</div>
					</div>
				</div>
			</div>
			<h2 class="search-promotion__heading search-promotion__heading--bottom title title--big title--white title--w-extra-bold title--indent"
			    data-num="–">
				Кому <span class="search-promotion__heading-accent title title--purple">НЕ подойдет</span> контекстная
				реклама
			</h2>
		...
		<div class="container">
			<div class="row mb-0 mb-md-3">
				<div class="col-12 text-center">
					<h2>Как мы запускаем контекстную рекламу</h2>
				</div>
			</div>
			<div class="row mb-5">
				<div class="col-12 col-md-3 d-flex nandtitle">
					<span class="number__slide">1</span>
					<span class="title ms-3">Анализ рынка</span>
				</div>
				<div class="col-12 col-md-9">
					Настройка рекламных объявлений начинается с анализа рынка, ниши бизнеса, конкурентов и целевой
					аудитории в Яндекс Директе и Google Ads.
				</div>
			</div>
			<div class="row mb-5">
				<div class="col-12 col-md-3 d-flex nandtitle">
					<span class="number__slide">2</span>
					<span class="title ms-3">Формирование стратегии</span>
				</div>
				<div class="col-12 col-md-9">
					Затем формируется стратегия рекламной кампании и оцифровываются цели для расчёта бюджета. Команда
					агентства составляет расширенное семантическое ядро, удаляя нецелевые фразы и клики.
				</div>
			</div>
			<div class="row mb-5">
				<div class="col-12 col-md-3 d-flex nandtitle">
					<span class="number__slide">3</span>
					<span class="title ms-3">Проработка объявлений</span>
				</div>
				<div class="col-12 col-md-9">
					После рекламные кампании разделяются на подкатегории, прорабатываются объявления и размещаются
					UTM-метки.
				</div>
			</div>
			<div class="row mb-5">
				<div class="col-12 col-md-3 d-flex nandtitle">
					...
					<span class="title ms-3">Запуск и ведение контекстной рекламы</span>
				</div>
				<div class="col-12 col-md-9">
					Только по результатам всех подготовительных работ начинается настройка рекламной кампании и
					объявления запускаются на поиске и на сайтах-партнёрах. Если пройти все этапы и тщательно
					проработать контекстную рекламу, результат и рост продаж не заставит ждать.
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-4">
                    ...
                    <span style="font-size:24px">01</span> Высокий процент кликабельности
                </span>
					<span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">Заголовки объявлений релевантны поисковому запросу пользователя, поэтому процент кликабельности выше. Поисковые системы «видят», что ваш продукт интересен и показывают объявление ещё большему числу пользователей — так вы привлечёте целевой трафик и снизите стоимость клика
Цена за лид формируется на этапе подписания договора и не меняется с течением времени.
                    </span>
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">02</span>Нативная подача
                </span>

					<span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
                 Реклама подаётся не «в лоб», а становится частью поисковой выдачи — это не отталкивает пользователей и приводит заинтересованную аудиторию на сайт быстрее, сразу после запуска контекстной рекламы.
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">03</span> Узкая направленность запросов
                </span>


					<span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
                 Узкие и высокоточные запросы помогают пользователю быстрее найти нужное, сужает поиск и, тем самым, облегчает решение его проблемы. В настройках рекламы можно выбрать регион, социальный статус, время повышенной активности посещений — так вы попадаете только в конкретный сегмент среди многомиллионной аудитории.
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">04</span> Оплата только за клики
                </span>


					<span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
                 С контекстной рекламой вы не платите за показы объявления. Если пользователь заметит рекламу, но пройдёт мимо, вы получите бесплатный охват и повышение узнаваемости. Оплачиваются только клики по объявлению — переходы пользователя на ваш сайт. При этом стоимость клика согласуется с заказчиком и зависит от частоты показа и позиции в поисковике.
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">05</span>Прозрачная работа
                </span>


					<span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
               Рекламную кампанию можно контролировать от начала и до конца: агентство согласует с вами содержание объявления, целевую аудиторию, время, место показа и рекламный бюджет. В статистике вы сможете отслеживать эффективность рекламной кампании, а агентство — своевременно корректировать настройки и оптимизировать бюджет.
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">06</span>Трансляция сразу после публикации
                </span>


					<span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
          Рекламные объявления начинают транслироваться на поиске или на сайтах-партнёрах сразу после запуска кампании. Заинтересованные пользователи тут же будут видеть ваше объявление и смогут по нему перейти на сайт.
	...
	<section class="section__wrap grayback pb-1 pb-sm-5">
		<div class="container">
			<div class="row">
				...
				<div
					class="col-sm-12 mt-4 mb-5 d-flex flex-lg-row flex-column align-items-center justify-content-center justify-content-lg-start gap-4">
                    ...
                    в обращение с рекламы достигала 14% <img src="/wp-content/uploads/2022/03/image-59.png"
                                                             alt="конверсия сайта">
                </span>
				</div>
	...
	<section class="section__wrap pb-1 pb-sm-5 type_ad">
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
					<h2>Подходящие инструменты для вашего бизнеса</h2>
				</div>
			</div>
			<div class="row">
                <!--ТУТ TAB2-->
                <div class="tab tab-2 active">
                    <div class="row mb-5">
                        ...
                        <div class="col-12 col-md-6 d-flex elem ps-md-5">
                            ...
                            <div class="ps-5 ps-md-3 col-11 d-flex flex-wrap">
                                <a href="/uslugi/kontekstnaya-reklama/yandex/">
                                    <div class="title">
                                        Контекстная реклама в Яндекс Директ
                                    </div>
                                </a>
                                <div class="descr">
                                    Это российский сервис контекстной рекламы. Рекламное объявление транслируется в
                                    поисковой выдаче и в Рекламной сети Яндекса. РСЯ рассчитана на «прохладную» аудиторию,
                                    поэтому коэффициент кликабельности может быть ниже, чем в рекламе на поиске, которая
                                    отвечает на точный запрос пользователя.
                                </div>
                                <a href="/uslugi/kontekstnaya-reklama/yandex/">
                                    <div class="right-arrow">
                                        <svg width="24" height="10" viewBox="0 0 24 10" fill="none"
                    ...
                    <div class="row mb-5">
                        <div class="col-12 col-md-6 d-flex elem pe-md-5 mb-5 mb-md-0">
                            ...
                            <div class="ps-5 ps-md-3 col-11 d-flex flex-wrap">
                                <a href="/uslugi/kontekstnaya-reklama/audit/">
                                    <div class="title">
                                        Аудит рекламной кампании
                                    </div>
                                </a>
                                <div class="descr">
                                    Это независимая и точная оценка запущенных кампаний, которая поможет определить слабые
                                    места и найти способы корректировки и оптимизации. Аудит, в отличие от анализа,
                                    проводится комплексно в разрезе сквозной аналитики, которая отслеживает путь клиента от
                                    первого клика до заявки, покупки и вероятности повторных обращений.
                                </div>
                                <a href="/uslugi/kontekstnaya-reklama/audit/">
                                    <div class="right-arrow">
                                        <svg width="24" height="10" viewBox="0 0 24 10" fill="none"
                        ...
                        <div class="col-12 col-md-6 d-flex elem ps-md-5">
                            ...
                            <div class="ps-5 ps-md-3 col-11 d-flex flex-wrap">
                                ...
                                <div class="descr">
                                    Это реклама на конкретный, узкий сегмент целевой аудитории. Кампания настраивается с
                                    учётом высокоточных характеристик: интересов, проблем и потребностей пользователей, их
                                    активности и поведении в интернете, местоположении или местам, которые они часто
                                    посещают.
                                </div>
                                <a href="/uslugi/kontekstnaya-reklama/audit/">
                                    <div class="right-arrow">
    ...
    padding-top: 70px;
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
					<h2 style="color:white">Цена настройки и ведения контекстной рекламы</h2>
				</div>
				...
				<div class="col-sm-12">
					<div class="">
						<table class="tarifs-table">
							<tr>
								<td>
									<svg class="mob-before-svg" width="21" height="16" viewBox="0 0 21 16" fill="none"
									     xmlns="http://www.w3.org/2000/svg">
										<path d="M18.5 3L7.5 14L2.5 9" stroke="white" stroke-width="3"
							...
							<tr>
								<td>
									...
									Изучение целевой аудитории и особенностей продукта
								</td>
								<td>
									<svg width="21" height="16" viewBox="0 0 21 16" fill="none"
									     xmlns="http://www.w3.org/2000/svg">
							...
							<tr>
								<td>
									...
									Настройка систем аналитики и статистики
								</td>
								<td>
									<svg width="21" height="16" viewBox="0 0 21 16" fill="none"
									     xmlns="http://www.w3.org/2000/svg">
							...
							<tr>
								<td>
									...
									Сбор и группировка ключевых запросов
								</td>
								<td>
									<svg width="21" height="16" viewBox="0 0 21 16" fill="none"
									     xmlns="http://www.w3.org/2000/svg">
							...
							<tr>
								<td>
									...
									Написание объявлений с учетом УТП продукта
								</td>
								<td>
									<svg width="21" height="16" viewBox="0 0 21 16" fill="none"
									     xmlns="http://www.w3.org/2000/svg">
	...
	<section class="slider__wrap">
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
					<h2><span>Какие работы</span> вы делаете при<br> настройке контекстной рекламы?</h2>
				</div>
				<div class="col-sm-12">
					<ul class="nav nav-pills mb-3" id="pills-tab" data-total="6" role="tablist">
						...
						<li class="nav-item" role="presentation">
							<button data-id="2" class="nav-link" id="pills-2-tab" data-bs-toggle="pill"
								...
								<span class="number__slide">2</span>
								<span class="text__slide">
                        Оцениваем и <br>дорабатываем сайт
                        </span>
							</button>
						</li>
						<li class="nav-item" role="presentation">
							<button data-id="3" class="nav-link" id="pills-3-tab" data-bs-toggle="pill"
								...
								<span class="number__slide">3</span>
								<span class="text__slide">
                        Разрабатываем <br>стратегию запуска
                        </span>
							</button>
						</li>
						<li class="nav-item" role="presentation">
						...
						<li class="nav-item" role="presentation">
							<button data-id="5" class="nav-link" id="pills-5-tab" data-bs-toggle="pill"
								...
								<span class="text__slide">
                        Настраиваем <br>рекламные кампании
                        </span>
							</button>
						</li>
						<li class="nav-item" role="presentation">
					...
					<div class="tab-content" id="pills-tabContent">
						<div class="tab-pane fade show active" id="pills-1" role="tabpanel"
							...
							<div class="row">
								<div class="col-sm-6">
									<h3><span>01</span>Погружаемся в ваш бизнес</h3>
									<div class="padding__content">
										<ul class="checklist">
											<li>Изучаем тематику</li>
											<li>Создаем портрет целевой аудитории</li>
											<li>Изучаем особенности продукта</li>
											<li>Проводим конкурентный анализ</li>
											<li>Оцениваем объем спроса</li>
										</ul>
									</div>
								</div>
								<div class="col-sm-6">
						...
						<div class="tab-pane fade" id="pills-2" role="tabpanel" aria-labelledby="pills-2-tab">
							<div class="row">
								<div class="col-sm-6">
									<h3><span>02</span>Анализируем сайт и повышаем его конверсию</h3>
									<div class="padding__content">
										<ul class="checklist">
											<li>Технические ошибки (долго загружается страница, проблемы с версткой)
											</li>
											<li>Смысловые ошибки (недостаточно информации для принятия решения)</li>
											<li>Конверсионные ошибки (непонятные заголовки, нет формы заявки)</li>
											<li>Контентные ошибки (орфография, некачественные изображения товара)</li>
											<li>Согласуем правки сайта, определяем сроки и исполнителей</li>
											<li>Внедряем правки и оцениваем конверсию</li>
										</ul>
									</div>
								</div>
								<div class="col-sm-6">
						...
						<div class="tab-pane fade" id="pills-3" role="tabpanel" aria-labelledby="pills-3-tab">
							<div class="row">
								<div class="col-sm-6">
									<h3><span>03</span>Разрабатываем и согласовываем стратегию запуска</h3>
									<div class="padding__content">
										<ul class="checklist">
											<li>Сегментируем аудиторию</li>
											<li>Определяем приоритетные для запуска продукты</li>
											<li>Выбираем приоритетные форматы рекламы</li>
											<li>Определяемся с рекламными системами: Яндекс.Директ / Google Adwords</li>
											<li>Настраиваем инструменты для сбора статистики и оценки эффективности
												рекламы
											</li>
											<li>Рассчитываем рекламный бюджет в соответствии с планом продаж</li>
										</ul>
									</div>
								</div>
								<div class="col-sm-6">
						...
						<div class="tab-pane fade" id="pills-4" role="tabpanel" aria-labelledby="pills-4-tab">
							<div class="row">
								<div class="col-sm-6">
									...
									<div class="padding__content">
										<ul class="checklist">
											<li>Добавляем счетчик Яндекс Метрики на сайт, настраиваем цели</li>
											<li>Добавляем Google Analytics на сайт, настраиваем цели</li>
											<li>Устанавливаем и настраиваем коллтрекинг для анализа заявок с телефона
											</li>
											<li>Устанавливаем и настраиваем e-mail-трекинг</li>
											<li>Другие систмемы аналитики</li>
										</ul>
									</div>
								</div>
								<div class="col-sm-6">
						...
						<div class="tab-pane fade" id="pills-5" role="tabpanel" aria-labelledby="pills-5-tab">
							<div class="row">
								<div class="col-sm-6">
									<h3><span>05</span>Настраиваем рекламные кампании</h3>
									<div class="padding__content">
										<ul class="checklist">
											<li>Выделяем ваши конкурентные преимущества в УТП для отстройки от
												конкурентов
											</li>
											<li>Собираем и структурируем ключевые слова, подбираем минус-слова</li>
											<li>Разрабатываем креативы для каждого сегмента аудитории</li>
											<li>Добавляем расширения объявления
												(быстрые ссылки, уточнения, контакты и пр.)
											</li>
											<li>Добавляем уникальные UTM-метки в ссылки для дальнейшей аналитики</li>
											<li>Подбираем релевантные посадочные страницы для каждого объявления</li>
						...
						<div class="tab-pane fade" id="pills-6" role="tabpanel" aria-labelledby="pills-6-tab">
							<div class="row">
								<div class="col-sm-6">
									<h3><span>06</span>Ведём рекламные кампании</h3>
									<div class="padding__content">
										<ul class="checklist">
											<li>Ежедневно контролируем количество обращений и их стоимость</li>
											<li>Еженедельно анализируем и корректируем параметров работы кампаний</li>
											<li>А/Б тесты креативов, параметров объявлений, посадочных страниц</li>
											<li>Тестируем новые форматы объявлений и стратегии</li>
											<li>Добавляем новые минус-слова</li>
											<li>Комбинируем ручное и автоматизированное управление рекламой</li>
											<li>Выходим на стоимость обращения, рентабельную для бизнеса</li>
										</ul>
									</div>
								</div>
								<div class="col-sm-6">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-7 my-auto">
                    ...
                    Качественный контекст -<br> это скрупулёзный сбор<br> семантики, математические<br> расчеты и <span>капелька<br> творчества</span>
                    </span>
...
<path
	...
	fill="#6430E8"/>
				...
				<div class="col-sm-6">
					<img src="/wp-content/uploads/2022/03/Отчёт о проделанных работах за прошлый месяц.png"
					     alt="контекст4">
				</div>
			</div>
...
<path
			...
			<div class="row">
				...
				<div class="col-sm-4">
                   ...
                   Контекстолог
						...
						<span class="advantage__text1">
                   Оценивает прошлые рекламные компании, настраивает и ведёт контекстную рекламу, отслеживает показатели, корректирует и оптимизирует бюджет
			...
			<div class="top-page__inner">
				<div class="top-page__info">
					...
					<div class="top-page__action">
						<a href="javascript:;" class="top-page__button button button--icon"
						   data-stc-modal="#feedback-stc">
		...
		<div class="container">
			...
			<div class="row qa-elem">
				...
				<div class="qa-content">
					Это рекламное объявление на поиске или сайтах-партнёрах, которое отвечает запросу пользователя.
				</div>
			</div>
			<div class="row qa-elem">
				<div class="qa-title">
					В чём разница между SEO и контекстной рекламой?
				</div>
				<div class="qa-content">
					SEO направлено в первую очередь на улучшение содержания сайта. Контент на сайте оптимизируется с
					помощью ключевых фраз, чтобы надолго повысить рейтинг в поисковой выдаче. Контекстная реклама
					работает только пока запущена, но приводит более «тёплую» и заинтересованную в покупке аудиторию.
					Оба способа эффективны, но в тандеме работают только лучше.
				</div>
			</div>
			<div class="row qa-elem">
				<div class="qa-title">
					Как работает контекстная реклама простыми словами?
				</div>
				<div class="qa-content">
					Интернет-реклама показывается в поисковой выдаче и на сайтах-партнёрах, чья ниша схожа с
					рекламируемым продуктом. Пользователь вводит запрос в строку поиска, а алгоритмы показывают
					объявления, релевантные его вопросу.
				</div>
			</div>
			<div class="row qa-elem">
				<div class="qa-title">
					Какая бывает контекстная реклама?
				</div>
				<div class="qa-content">
					Объявление может быть текстовым, графическим, комбинированным, динамическим или в формате видео.
			...
			<div class="row qa-elem">
				<div class="qa-title">
					Сколько в среднем стоит контекстная реклама?
				</div>
				<div class="qa-content">
					Стоимость определяется масштабом бизнеса, продолжительностью демонстрации, уровнем конкуренции и
					местом размещения. Для разной целевой аудитории подходят соответствующие товары и услуги, а также
					подача информации, что тоже влияет на цену.
				</div>
			</div>

			<div class="row qa-elem">
				<div class="qa-title">
					Как я смогу контролировать ход рекламной кампании и ее результаты?
				</div>
				<div class="qa-content">
					Качество настройки контекстной рекламы проверяют сверяя поисковые запросы с заголовками объявлений и
					посадочных страниц, контролируя группировку ключей по отдельным сегментам целевой аудитории,
					разделение компаний по направлениям продвижения, географическому таргетингу и многому другому.
					Эффективность рекламных кампаний в конечном счете определяется количеством заявок и их ценой.
				</div>
			</div>
	...
	<section class="section__wrap grayback pb-1 pb-sm-5">
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
					<h2 class="mob-center">Смотрите еще</h2>
				</div>
			</div>
			...
			<div class="os-cards">
                <div class="col-sm-3 os-card">
                    ...
                    <div class="os-card-content">
                        Контекстная реклама в Яндекс Директ показывается в результатах поиска и на сайтах партнеров
                        Яндекса (РСЯ).
                    </div>
                    <div class="os-price">
                        от 60 000 ₽
                ...
                <div class="col-sm-3 os-card">
                    ...
                    <div class="os-card-content">
                        Контекстная реклама в Google Ads показывается в результатах поиска Google и на сайтах партнеров
                        Google, которые входят в контекстно-медийную сеть Google (КМС).
                    </div>
                    <div class="os-price">
                        от 60 000 ₽
                    </div>
