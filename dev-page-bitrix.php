...
<section class="section__wrap grayback pb-1 pb-sm-5" style="background-color:white">
	<div class="container">
		...
		<div class="col-sm-4">
                    ...
                    <span style="font-size:24px">01</span>Понятная панель управления
                </span>
                    <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
                  Интуитивно понятный дизайн, визуальный редактор, поиск в панели управления и наличие круглосуточной техподдержки — все это облегчает работу с сайтом. Есть возможность настройки горячих клавиш. Сайт открывается одновременно в демонстрационном окне и в окне администрирования (на двух вкладках браузера).
                    </span>
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">02</span> Масштабируемость
                </span>
                    
                  <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
              Часто клиенты приходят с запросом сделать небольшой сайт, но с возможностью дальнейшего расширения до корпоративного. В Битриксе есть все для этого. Часть функций можно активировать самостоятельно, за решением сложных задач придется обратиться к разработчику.
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">03</span> «Коробочный» функционал
                </span>

                    
                  <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
                Дополнительные модули, всевозможные инструменты для развития электронной коммерции — от встроенных платежных систем до отправки отчетности. Превосходный вариант для любого крупного сайта, в том числе — интернет магазина.
                    </span>
               
            </div>
			<div class="col-sm-4" style="margin-top: 20px;">
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">04</span>Адаптивная верстка
                </span>

                    <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
                 Готовые сайты одинаково отображаются на любых устройствах, будь то настольный ПК или небольшой смартфон. Клиент (или программист) вносит нужные изменения в цветовую палитру и контент.
                    </span>
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">05</span>Интеграция с 1С
                </span>


                    
                    <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
               За счет специального модуля Битрикс поддерживает обмен информацией с базой данных 1С по расписанию или в режиме реального времени. Также клиент может самостоятельно сформировать нужную структуру каталога.
                    </span>
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">06</span>Стабильная работа даже при значительной нагрузке
                </span>


                    
                    <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
             При правильной настройке сервера и грамотной сборке сайт на Битриксе легко выдерживает и высокую посещаемость, и большие объемы выгружаемой из 1С информации. Магазин на Битриксе загружается в течение 500 мс, скорость ответа страниц при этом составляет 150 мс, при подключении композитного кэширования — 10 мс.
                    </span>
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">07</span>Встроенные инструменты для SEO
                </span>


                    
                    <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
             В CMS уже встроен модуль, который помогает адаптировать весь сайт или оптимизировать отдельные страницы под требования поисковых систем.
                    </span>
...
<section class="slider__wrap">
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-12">
            <ul class="nav nav-pills mb-3" id="pills-tab" data-total="7" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    ...
                    <span class="number__slide">5</span>
                        <span class="text__slide">
                     Подбор домена,<br> размещение на хостинге
                        </span>
                    </button>
                </li>
				<li class="nav-item" role="presentation">
                ...
                <div class="tab-pane fade show active" id="pills-1" role="tabpanel" aria-labelledby="pills-1-tab">
                    <div class="row">
                        <div class="col-sm-6">
                            <h3><span>01</span>Техническое задание</h3>
                            <div class="padding__content">
							Перед запуском проекта необходимо учесть поставленные заказчиком цели, сроки решения задачи, бюджет, технические детали. Для этого пишется ТЗ, которое согласовывается с представителями клиентской компании.
                            </div>
                        </div>
                        <div class="col-sm-6">
                ...
                <div class="tab-pane fade" id="pills-2" role="tabpanel" aria-labelledby="pills-2-tab">
                    <div class="row">
                        <div class="col-sm-6">
                            <h3><span>02</span>Разработка структуры,<br> прототипирование</h3>
                            <div class="padding__content">
                                После утверждения ТЗ приступают ко второму этапу создания сайта. Маркетологи совместно с дизайнером выполняют черновой набросок будущего интернет магазина, корпоративного сайта, лендинга или портала.
                            </div>
                        </div>
                        <div class="col-sm-6">
                ...
                <div class="tab-pane fade" id="pills-3" role="tabpanel" aria-labelledby="pills-3-tab">
                    <div class="row">
                        <div class="col-sm-6">
                            <h3><span>03</span>Разработка дизайна</h3>
                            <div class="padding__content">
                                На основе прототипа дизайнер делает «цветной» макет, чтобы заказчик мог видеть, как будет выглядеть будущий сайт. По запросу компании создается одновременно 2-3 эскиза, из которых выбирается один.
                            </div>
                        </div>
                        <div class="col-sm-6">
                ...
                <div class="tab-pane fade" id="pills-4" role="tabpanel" aria-labelledby="pills-4-tab">
                    <div class="row">
                        <div class="col-sm-6">
                            <h3><span>04</span>Верстка и программирование</h3>
                            <div class="padding__content">
                              Благодаря усилиям программиста и верстальщика сайт превращается в готовый продукт. Во время работы учитывают особенности системы Битрикс, чтобы при ее установке не возникло проблем.
                            </div>
                        </div>
                        <div class="col-sm-6">
                ...
                <div class="tab-pane fade" id="pills-5" role="tabpanel" aria-labelledby="pills-5-tab">
                    <div class="row">
                        <div class="col-sm-6">
                            <h3><span>05</span>Подбор доменного имени,<br> размещение на хостинге</h3>
                            <div class="padding__content">
                               Подбор домена для сайта происходит совместно с заказчиком. Доменное имя должно соответствовать названию бренда, продукту или услуге, которую предлагает клиентская компания. Физическое тело сайта (код) располагается на сервере. От выбора хостинга в немалой степени зависит скорость быстродействия и защищенность ресурса. 
                            </div>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <h3><span>06</span>Установка и интеграция<br> модулей CMS </h3>
                            <div class="padding__content">
                              После завершения разработки сайта на него устанавливают Битрикс. За техническую настройку отвечает программист.
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <img src="/wp-content/uploads/2022/03/device-macbook-pro-6.png" alt="Верстка и разработка">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <h3><span>07</span>Наполнение сайта</h3>
                            <div class="padding__content">
                            Теперь сайт готов к наполнению содержимым. Заказчик занимается этим самостоятельно или доверяет данный этап маркетинговому агентству Сайткрафт. Затем сайт с установленным Битриксом проверяется на предмет ошибок.
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <img src="/wp-content/uploads/2022/03/device-macbook-pro-6.png" alt="Верстка и разработка">
        ...
        <div class="row qa-elem">
           ...
           Сколько стоит создание сайта на Битрикс? 
            ...
            <div class="qa-content">
             Стоимость разработки сайта на Битрикс зависит от размера веб проекта и объема предоставляемых услуг. Создание интернет магазина с каталогом или корпоративного сайта в Москве обойдется дороже, нежели создание лендинга, состоящего из одной страницы.
            </div>
        </div>
		<div class="row qa-elem">
            <div class="qa-title">
            ...
            <div class="qa-content">
          Перед оказанием услуги маркетинговое агентство определяет цели работы. На основе этого выбирается и ПО для управления веб проектом. Битрикс подходит для корпоративных сайтов, интернет-магазинов с каталогом любого размера, сайтов визиток, интернет порталов.
            </div>
        </div>
		<div class="row qa-elem">
            <div class="qa-title">
          Как интегрировать сайт после разработки с Bitrix24?
            ...
            <div class="qa-content">
           Выделяют четыре главных варианта интеграции сайта с данным сервисом Битрикс. Выбор зависит от поставленных задач. Можно разместить на сайте бесплатный виджет, форму обратной связи, интегрировать сервис с электронной почтой или с интернет магазином.
            </div>
        </div>
        <div class="row qa-elem">
            <div class="qa-title">
         Можно ли перенести сайт на Битрикс? 
            ...
            <div class="qa-content">
           Большинство сайтов можно перенести на Битрикс, однако работать с проектом должен профессионал. Иначе гарантированы проблемы с SEO продвижением, падение позиций в поисковой выдаче. Лучше всего подходят для переноса корпоративные сайты и интернет магазины, проекты, уже имеющие админку.
            </div>
        </div>
      <div class="row qa-elem">
            <div class="qa-title">
       Чем Битрикс лучше аналогичных платформ? 
            ...
            <div class="qa-content">
          ПО защищает сайт от взлома, обеспечивает легкое управление, облегчает продвижение проекта в интернете. Из других плюсов можно назвать круглосуточную техподдержку, автоматизацию бизнес процессов и интеграцию сайта с базой 1С.
            </div>
        </div>
    </div>
</section>
