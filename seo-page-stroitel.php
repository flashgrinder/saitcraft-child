<?php
/*
Template Name: SEO-продвижение строительных сайтов
*/
get_header();
?>
...
<section class="section__wrap crm__page context__page-rows">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <h2>Кому подойдет SEO продвижение</h2>
            </div>
        </div>
    </div>
    <div class="container">
...
</span>Застройщикам жилых и производственных помещений</h3>
<div style="margin-left: 55px; margin-bottom: 20px;">
	
				
<span style="font-size:16px; color:#667399">многоквартирных домов, школ и детских садов, загородных домов и других
<br></span>
				</div>
				<h3 style="margin-bottom: 5px;"><span>
<svg width="28" height="21" viewBox="0 0 28 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</span>Производителям строительных материалов с выходом на российский рынок</h3>
<div style="margin-left: 55px; margin-bottom: 20px;">
	
				
<span style="font-size:16px; color:#667399">бетона, кирпича, отделочных плит, напольных покрытий и других<br></span>
				</div>
				<h3 style="margin-bottom: 5px;"><span>
<svg width="28" height="21" viewBox="0 0 28 21" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M24.6666 3.33325L9.99992 17.9999L3.33325 11.3333" stroke="#00ADA8" stroke-width="4" stroke-linecap="square"/>
...
</span>Торговым предприятиям оптовых и розничных продаж</h3>
<div style="margin-left: 55px; margin-bottom: 20px;">
	
				
<span style="font-size:16px; color:#667399">которые работают с покупателями из ближайших местностей<br></span>
				</div>
				<h3 style="margin-bottom: 5px;"><span>
<svg width="28" height="21" viewBox="0 0 28 21" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M24.6666 3.33325L9.99992 17.9999L3.33325 11.3333" stroke="#00ADA8" stroke-width="4" stroke-linecap="square"/>
...
</span>Компаниям, которые занимаются ремонтом</h3>
<div style="margin-left: 55px; margin-bottom: 20px;">
	
				
<span style="font-size:16px; color:#667399">устанавливают окна, проводят отделочные, монтажные или электрические работы чаще только в одном регионе<br></span><br><br>
				</div>
...
</span>Форумам, журналам и порталам строительной тематики</h3>
<div style="margin-left: 55px; margin-bottom: 20px;">
	
				
<span style="font-size:16px; color:#667399">которые уже занимают высокие позиции в результатах поиска или стремятся к этому
<br></span><br><br>
				</div>
...
</span>Интернет-магазинам товаров строительной тематики</h3>
<div style="margin-left: 55px; margin-bottom: 20px;">
	
				
<span style="font-size:16px; color:#667399">стройматериалов, инструментов, товаров для строителей, которые можно заказать с доставкой на широкую территорию
<br></span><br><br>
				</div>
            ...
            <div class="col-sm-4 right-seo" >
                 <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <h2>СЕО продвижение<br/> сайтов не подходит</h2>
                            </div>
                        </div>
                    </div>
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12" >
                                ...
                                </span>Лендингам<br/>и малостраничным ресурсам</h3>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="point1 point__wrap">
                    ...
                    <span class="point__text">Больше клиентов<br>увидят ваш сайт в поиске</span>
                </div>
                <div class="point2 point__wrap">
                    <span class="point__number">02</span>
                    <span class="point__text">Повышение узнаваемости<br>компании</span>
                </div>
                <div class="point3 point__wrap">
                    <span class="point__number">03</span>
                    <span class="point__text">Увеличение<br>количества заявок</span>
                </div>
                <div class="point4 point__wrap">
                    <span class="point__number">04</span>
                    <span class="point__text">Стабильный поток обращений<br> даже после окончания работ</span>
                </div>
            </div>
            <div class="col-sm-12 mt-4 mb-5 d-flex align-items-center gap-3 abs__block">
                <a href="javascript:;" class="button button--icon" data-stc-modal="#feedback-stc">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<section class="section__wrap grayback pb-1 pb-sm-5" style="background-color:white">
	<div class="container">
		...
		<div class="col-sm-12" style="text-align: center;">
                <h2>Особенности SEO-продвижения строительных сайтов</h2>
            </div>
		<div class="col-sm-4">
                    ...
                    <span style="font-size:24px">01</span>Сезонность
                </span>
                    <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
                   Весной и летом посещения сайта стремительно растут, а к зиме начинают падать. 
На сайтах ремонтных компаний посещаемость стабильнее: офисы и квартиры можно ремонтировать круглый год.
                    </span>
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">02</span>Регион
                </span>
                    
                  <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
                 Большинство строительных компаний ориентируются только на свой регион. Чаще только крупные организации выходят за его пределы.
                    </span>
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">03</span>Время
                </span>

                    
                  <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
                    Взаимодействие с клиентом намного дольше: от подготовки к работам, до их завершения. Трансляция экспертности и надёжности компании на протяжении всего периода работ поможет привлечь новую аудиторию через «сарафанное радио» и поисковые запросы.
                    </span>
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">04</span>Репутация
                </span>


                    
                    <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
                  Надёжная репутация компании или  интернет-магазина в строительной нише — важный критерий при выборе подрядчика. Поэтому важно оперативно реагировать на отзывы клиентов. 
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">05</span>Конкуренты
                </span>


                    
                    <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
                  Необходимо регулярно анализировать конкурентов-лидеров и их каналы продвижения, чтобы адаптировать сайт и оптимизировать продвижение.
                    </span>
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">06</span>Аудитория
                </span>


                    
                    <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
                  Для эффективного SEO-продвижения нужен точный, полный и актуальный портрет целевой аудитории, её интересов и потребностей 
                    </span>
...
<div class="container">
    <div class="row">
        <div class="col-md-10" style="width:100%">
            <h2 style="text-align: center;">Отличия SEO-продвижения для строительных компаний</h2>
...
<path d="M36.2197 49.4697L37.2803 50.5303L38.25 49.5605V50.75C38.25 51.1632 37.914 51.5 37.5 51.5H33C31.7595 51.5 30.75 52.5095 30.75 53.75V54.5758C29.0408 54.9245 27.75 56.4395 27.75 58.25C27.75 59.27 28.1618 60.194 28.8247 60.8705C26.8808 61.6407 25.5 63.5352 25.5 65.75V67.25C25.5 67.664 25.8353 68 26.25 68H36.75C37.1648 68 37.5 67.664 37.5 67.25V65.75C37.5 63.5352 36.1193 61.6407 34.1753 60.8705C34.8383 60.194 35.25 59.27 35.25 58.25C35.25 56.4395 33.9593 54.9245 32.25 54.5758V53.75C32.25 53.3368 32.586 53 33 53H37.5C38.7405 53 39.75 51.9905 39.75 50.75V49.5605L40.7197 50.5303L41.7803 49.4697L39.5303 47.2197C39.384 47.0735 39.192 47 39 47C38.808 47 38.616 47.0735 38.4697 47.2197L36.2197 49.4697ZM36 65.75V66.5H27V65.75C27 63.6823 28.6823 62 30.75 62H32.25C34.3177 62 36 63.6823 36 65.75ZM33.75 58.25C33.75 59.4905 32.7405 60.5 31.5 60.5C30.2595 60.5 29.25 59.4905 29.25 58.25C29.25 57.0095 30.2595 56 31.5 56C32.7405 56 33.75 57.0095 33.75 58.25Z" fill="white"/>
                    ...
                    Зависимость от региональности
                    </span>
                    <span class="advantage__text1">
                   Чаще строительные компании работают только в одном регионе, поэтому семантическое ядро составляем только из геозависимых запросов, подробно прорабатываем контактные данные, регистрируем сайт в Яндекс Бизнесе,  указываем регион продвижения и точный адрес строительной компании в Яндекс Вебмастере.
                    </span>
</div>
                </div>
                <div class="advantage__item">
...
<path d="M49.5 53H51V54.5H49.5V53Z" fill="white"/>
                    ...
                    <span class="advantage__text1">
                  Жёсткая конкуренция ниши заставляет подробно прорабатывать посадочные страницы. Добавляем информацию о ценах и подробно рассказываем о компании, прикладываем сканы отзывов и благодарностей 
                    </span>
</div>
                </div>
                <div class="advantage__item">
...
<path d="M56.9978 50.0552C58.4812 50.0552 59.9312 49.6153 61.1646 48.7912C62.3979 47.9671 63.3592 46.7957 63.9269 45.4253C64.4946 44.0549 64.6431 42.5469 64.3537 41.092C64.0643 39.6371 63.35 38.3008 62.3011 37.2519C61.2522 36.203 59.9158 35.4887 58.461 35.1993C57.0061 34.9099 55.4981 35.0584 54.1277 35.6261C52.7572 36.1937 51.5859 37.155 50.7618 38.3884C49.9377 39.6218 49.4978 41.0718 49.4978 42.5552C49.5001 44.5436 50.291 46.45 51.697 47.856C53.103 49.262 55.0094 50.0529 56.9978 50.0552ZM56.9978 36.5552C58.1845 36.5552 59.3445 36.9071 60.3312 37.5664C61.3179 38.2256 62.087 39.1627 62.5411 40.2591C62.9952 41.3554 63.114 42.5618 62.8825 43.7257C62.651 44.8896 62.0796 45.9587 61.2404 46.7978C60.4013 47.6369 59.3322 48.2084 58.1683 48.4399C57.0045 48.6714 55.7981 48.5526 54.7017 48.0985C53.6053 47.6443 52.6683 46.8753 52.009 45.8886C51.3497 44.9019 50.9978 43.7419 50.9978 42.5552C50.9996 40.9644 51.6323 39.4394 52.7572 38.3145C53.882 37.1897 55.4071 36.557 56.9978 36.5552Z" fill="white"/>
                    ...
                    <div>
                    <span class="advantage__title1">
                    Сезонные вспышки интереса
                    </span>
                    <span class="advantage__text1">
                  К росту посещаемости весной и летом стоит готовиться за 3–4 месяца до пика спроса, который приходится на период с ноября по март. Иначе можно опоздать к началу сезона и потерять трафик
                    </span>
</div>
                </div>
...
<path d="M56.9978 50.0552C58.4812 50.0552 59.9312 49.6153 61.1646 48.7912C62.3979 47.9671 63.3592 46.7957 63.9269 45.4253C64.4946 44.0549 64.6431 42.5469 64.3537 41.092C64.0643 39.6371 63.35 38.3008 62.3011 37.2519C61.2522 36.203 59.9158 35.4887 58.461 35.1993C57.0061 34.9099 55.4981 35.0584 54.1277 35.6261C52.7572 36.1937 51.5859 37.155 50.7618 38.3884C49.9377 39.6218 49.4978 41.0718 49.4978 42.5552C49.5001 44.5436 50.291 46.45 51.697 47.856C53.103 49.262 55.0094 50.0529 56.9978 50.0552ZM56.9978 36.5552C58.1845 36.5552 59.3445 36.9071 60.3312 37.5664C61.3179 38.2256 62.087 39.1627 62.5411 40.2591C62.9952 41.3554 63.114 42.5618 62.8825 43.7257C62.651 44.8896 62.0796 45.9587 61.2404 46.7978C60.4013 47.6369 59.3322 48.2084 58.1683 48.4399C57.0045 48.6714 55.7981 48.5526 54.7017 48.0985C53.6053 47.6443 52.6683 46.8753 52.009 45.8886C51.3497 44.9019 50.9978 43.7419 50.9978 42.5552C50.9996 40.9644 51.6323 39.4394 52.7572 38.3145C53.882 37.1897 55.4071 36.557 56.9978 36.5552Z" fill="white"/>
                    ...
                    <div>
                    <span class="advantage__title1">
                    Пользователи выбирают Яндекс
                    </span>
                    <span class="advantage__text1">
                 По нашим данным, до 70% пользователей сайтов строительной тематики обращаются к Яндексу, поэтому уделяем этой поисковой системе особое внимание.
                    </span>
</div>
                </div>
...
<path d="M56.9978 50.0552C58.4812 50.0552 59.9312 49.6153 61.1646 48.7912C62.3979 47.9671 63.3592 46.7957 63.9269 45.4253C64.4946 44.0549 64.6431 42.5469 64.3537 41.092C64.0643 39.6371 63.35 38.3008 62.3011 37.2519C61.2522 36.203 59.9158 35.4887 58.461 35.1993C57.0061 34.9099 55.4981 35.0584 54.1277 35.6261C52.7572 36.1937 51.5859 37.155 50.7618 38.3884C49.9377 39.6218 49.4978 41.0718 49.4978 42.5552C49.5001 44.5436 50.291 46.45 51.697 47.856C53.103 49.262 55.0094 50.0529 56.9978 50.0552ZM56.9978 36.5552C58.1845 36.5552 59.3445 36.9071 60.3312 37.5664C61.3179 38.2256 62.087 39.1627 62.5411 40.2591C62.9952 41.3554 63.114 42.5618 62.8825 43.7257C62.651 44.8896 62.0796 45.9587 61.2404 46.7978C60.4013 47.6369 59.3322 48.2084 58.1683 48.4399C57.0045 48.6714 55.7981 48.5526 54.7017 48.0985C53.6053 47.6443 52.6683 46.8753 52.009 45.8886C51.3497 44.9019 50.9978 43.7419 50.9978 42.5552C50.9996 40.9644 51.6323 39.4394 52.7572 38.3145C53.882 37.1897 55.4071 36.557 56.9978 36.5552Z" fill="white"/>
                    ...
                    <div>
                    <span class="advantage__title1">
                   Каналы для успешного продвижения сайта
                    </span>
                    <span class="advantage__text1">
                Повысить эффективность SEO-продвижения помогут: контент-маркетинг, регистрация в каталогах строительных компаний и крауд-маркетинг.
                    </span>
</div>
                </div>
...
<path d="M56.9978 50.0552C58.4812 50.0552 59.9312 49.6153 61.1646 48.7912C62.3979 47.9671 63.3592 46.7957 63.9269 45.4253C64.4946 44.0549 64.6431 42.5469 64.3537 41.092C64.0643 39.6371 63.35 38.3008 62.3011 37.2519C61.2522 36.203 59.9158 35.4887 58.461 35.1993C57.0061 34.9099 55.4981 35.0584 54.1277 35.6261C52.7572 36.1937 51.5859 37.155 50.7618 38.3884C49.9377 39.6218 49.4978 41.0718 49.4978 42.5552C49.5001 44.5436 50.291 46.45 51.697 47.856C53.103 49.262 55.0094 50.0529 56.9978 50.0552ZM56.9978 36.5552C58.1845 36.5552 59.3445 36.9071 60.3312 37.5664C61.3179 38.2256 62.087 39.1627 62.5411 40.2591C62.9952 41.3554 63.114 42.5618 62.8825 43.7257C62.651 44.8896 62.0796 45.9587 61.2404 46.7978C60.4013 47.6369 59.3322 48.2084 58.1683 48.4399C57.0045 48.6714 55.7981 48.5526 54.7017 48.0985C53.6053 47.6443 52.6683 46.8753 52.009 45.8886C51.3497 44.9019 50.9978 43.7419 50.9978 42.5552C50.9996 40.9644 51.6323 39.4394 52.7572 38.3145C53.882 37.1897 55.4071 36.557 56.9978 36.5552Z" fill="white"/>
                   ...
                   Работа над конверсией
                    ...
                    <span class="advantage__text1">
                  Проводим юзабилити аудит строительных сайтов, добавляем элементы повышения конверсии: галерею реализованных проектов, калькулятор предварительного расчета стоимости и другие интерактивные элементы.
                    </span>
</div>
                </div>
...
<path d="M56.9978 50.0552C58.4812 50.0552 59.9312 49.6153 61.1646 48.7912C62.3979 47.9671 63.3592 46.7957 63.9269 45.4253C64.4946 44.0549 64.6431 42.5469 64.3537 41.092C64.0643 39.6371 63.35 38.3008 62.3011 37.2519C61.2522 36.203 59.9158 35.4887 58.461 35.1993C57.0061 34.9099 55.4981 35.0584 54.1277 35.6261C52.7572 36.1937 51.5859 37.155 50.7618 38.3884C49.9377 39.6218 49.4978 41.0718 49.4978 42.5552C49.5001 44.5436 50.291 46.45 51.697 47.856C53.103 49.262 55.0094 50.0529 56.9978 50.0552ZM56.9978 36.5552C58.1845 36.5552 59.3445 36.9071 60.3312 37.5664C61.3179 38.2256 62.087 39.1627 62.5411 40.2591C62.9952 41.3554 63.114 42.5618 62.8825 43.7257C62.651 44.8896 62.0796 45.9587 61.2404 46.7978C60.4013 47.6369 59.3322 48.2084 58.1683 48.4399C57.0045 48.6714 55.7981 48.5526 54.7017 48.0985C53.6053 47.6443 52.6683 46.8753 52.009 45.8886C51.3497 44.9019 50.9978 43.7419 50.9978 42.5552C50.9996 40.9644 51.6323 39.4394 52.7572 38.3145C53.882 37.1897 55.4071 36.557 56.9978 36.5552Z" fill="white"/>
                    ...
                    <div>
                    <span class="advantage__title1">
                  Глубокая проработка страниц
                    </span>
                    <span class="advantage__text1">
                 В строительной нише важно всесторонне раскрыть суть услуги на посадочной странице. Поэтому добавляем интерактивные элементы, отзывы клиентов, цены и, конечно, ключевые запросы.
                    </span>
</div>
                </div>
    ...
    <div class="container">
        <div class="row mb-0 mb-md-3">
            <div class="col-12 text-center">
                <h2>Зачем продвигать строительные сайты и вкладывать в это деньги</h2>
            </div>
        </div>
        <div class="row mb-5">
            <div class="col-12 col-md-3 d-flex nandtitle">
                <span class="number__slide">1</span>
                <span class="title ms-3">Расширение клиентской базы</span>
            </div>
            <div class="col-12 col-md-9">
             Оптимизировать сайт под поисковые алгоритмы и расширить клиентскую базу
            </div>            
        </div>
        <div class="row mb-5">
            <div class="col-12 col-md-3 d-flex nandtitle">
                <span class="number__slide">2</span>
                <span class="title ms-3">Создание сайта</span>
            </div>
            <div class="col-12 col-md-9">
               Создать новый сайт или доработать текущий, учитывая реальные потребности покупателей.
            </div>            
        </div>
        <div class="row mb-5">
            <div class="col-12 col-md-3 d-flex nandtitle">
                <span class="number__slide">3</span>
                <span class="title ms-3">Удобство для пользователей</span>
            </div>
            <div class="col-12 col-md-9">
               Улучшить дизайн и юзабилити сайта, проработать контент и содержание страниц
            </div>            
        </div>
		<div class="row mb-5">
            <div class="col-12 col-md-3 d-flex nandtitle">
                <span class="number__slide">4</span>
                <span class="title ms-3">Экспертность компании</span>
            </div>
            <div class="col-12 col-md-9">
               Демонстрировать экспертность, компетентность и успех компании
            </div>            
        </div>
		<div class="row mb-5">
            <div class="col-12 col-md-3 d-flex nandtitle">
                <span class="number__slide">5</span>
                <span class="title ms-3">Увеличение прибыли</span>
            </div>
            <div class="col-12 col-md-9">
            Увеличить прибыль, привлекая заинтересованных пользователей 
            </div>            
        </div>
    </div>
</section>
<section class="section__wrap grayback pb-1 pb-sm-5" style="background: #1A1E23 url(/img/team/2.svg);
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12" >
                <h2 style="color:white">Стоимость SEO продвижения</h2>
            </div>	
...
<section class="slider__wrap slider__seo">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <h2>Этапы продвижения сайта строительной компании</h2>
            </div>
            <div class="col-sm-12">
...
<li>Составляем ТЗ на доработку дизайна и юзабилити</li>
<li>Формируем задание на доработку контента</li>
 ...
 <li> Оцениваем релевантность страниц и дорабатываем их</li>
                ...
                <div class="tab-pane fade" id="pills-4" role="tabpanel" aria-labelledby="pills-4-tab">
                    <div class="row">
                        <div class="col-sm-6">
                            <h3><span>04</span>Внешняя оптимизация</h3>
                            <div class="padding__content">
                                <ul class="dots__opacity">
...
<li>Размещаем предложения на спецпорталах и торговых площадках в соответствии с планом</li>
                ...
                <div class="tab-pane fade" id="pills-5" role="tabpanel" aria-labelledby="pills-5-tab">
                    <div class="row">
                        <div class="col-sm-6">
                            <h3><span>05</span>Работа с CTR</h3>
                            <div class="padding__content">
                                <ul class="dots__opacity">
									<li>  Обновляем данные в Яндекс.Бизнес и Google.Мой бизнес </li>
<li>Формируем красивый вид сниппета для увеличения потока пользователей</li>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-6">
               ...
               В некоторых случаях результат можно будет увидеть уже через 3-5 недель, но в среднем устойчивые результаты будут после 2-3 месяцев работы.
                </span>
            </div>
            <div class="col-sm-6">
                <span class="seo__banner1-title">
...
<section class="section__wrap grayback pb-1 pb-sm-5">
    <div class="container">
        ...
        <div class="row qa-elem">
            <div class="qa-title">
               Как раскрутить свою строительную фирму?
            </div>
            <div class="qa-content">
               После регистрации саморегулируемой организации (СРО) изучите конкурентов в регионе и выберите тип рекламы для продвижения. Затем, перед началом продвижения, обновите старый или создайте новый сайт — он будет «лицом» вашей компании и должен соответствовать. Создание сайта лучше доверить профессионалам, которые следят за трендами дизайна и разработки и смогут внедрить на сайт все необходимые функции. Сайт будет постоянно совершенствоваться и развиваться вместе с бизнесом и его репутацией. 
            </div>
        </div>
		<div class="row qa-elem">
            <div class="qa-title">
               Где лучше всего продвигать строительные услуги?  
            </div>
            <div class="qa-content">
              Продвигать сайт можно в социальных сетях, на профильных форумах или блогах, через контекстную рекламу, сайты с объявлениями и с помощью SEO. Помните, что эффективность рекламы оценивается не только количеством новых клиентов, но и количеством заказов.
            </div>
        </div>
		<div class="row qa-elem">
            <div class="qa-title">
               Где разместить рекламу строительной компании?
            </div>
            <div class="qa-content">
              Выбирая площадку для размещения рекламы, делайте упор на те, которыми пользуется большая часть целевой аудитории. Строительным компаниям, сосредоточенным в одном регионе, подойдут: 
				<ul>
					<li>рекламные ролики и анонсы на телевидении и радио;</li>
<li>уличные баннеры и реклама в общественном транспорте;</li>
<li>реклама или выступления на тематических выставках, конференциях и форумах;</li>
<li>интернет-реклама, например, размещение в районных и городских группах, реклама на Поиске и в РСЯ или таргетированная реклама.</li>
				</ul>
            </div>
        </div>
        <div class="row qa-elem">
            <div class="qa-title">
               Сколько стоят услуги SEO?  
            </div>
            <div class="qa-content">
              На стоимость поисковой оптимизации, объёмной и комплексной работы, влияет:
				<ul>
<li>выбор подрядчика: агентство, фрилансер или сотрудник в штат;  </li>
<li>ниша, сезонность и регион бизнеса;  </li>
<li>необходимые работы по SEO-продвижению; </li>
<li>состав команды — может понадобиться помощь вебмастера, разработчика, копирайтера или аккаунт-менеджера; </li>
					<li>способ раскрутки: за позицию в поисковой выдаче (продвижение по позициям), за переходы на сайт (продвижение по трафику) или за целевые действия (продвижение по лидам).  </li>
				</ul>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row os-cards">
            ...
            <div class="col-sm-3 os-card">
                ...
                <div class="os-card-content">
                   Делали прирост по трафику более чем в 20 раз. Первые результаты будут видны уже через 2-3 месяца
