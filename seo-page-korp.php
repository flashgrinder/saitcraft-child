<?php
/*
Template Name: SEO-продвижение корпоративных сайтов
*/
get_header();
?>
...
<section class="section__wrap crm__page context__page-rows">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <h2>Кому подходит SEO продвижение</h2>
            </div>
        </div>
    </div>
    <div class="container">
...
</span>Торгово-коммерческим организациям</h3>
<div style="margin-left: 55px; margin-bottom: 20px;">
	
				
<span style="font-size:16px; color:#667399">сетевым магазинам, медицинским учреждениям<br></span>
				</div>
				<h3 style="margin-bottom: 5px;"><span>
<svg width="28" height="21" viewBox="0 0 28 21" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M24.6666 3.33325L9.99992 17.9999L3.33325 11.3333" stroke="#00ADA8" stroke-width="4" stroke-linecap="square"/>
...
</span>Промышленным предприятиям разного масштаба</h3>
<div style="margin-left: 55px; margin-bottom: 20px;">
	
				
<span style="font-size:16px; color:#667399">заводам, фабрикам, фермерским хозяйствам<br></span>
				</div>
				<h3 style="margin-bottom: 5px;"><span>
<svg width="28" height="21" viewBox="0 0 28 21" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M24.6666 3.33325L9.99992 17.9999L3.33325 11.3333" stroke="#00ADA8" stroke-width="4" stroke-linecap="square"/>
...
</span>Розничным и оптовым торговым сетям</h3>
<div style="margin-left: 55px; margin-bottom: 20px;">
	
				
<span style="font-size:16px; color:#667399">магазинам продуктов и одежды, интернет-магазинам<br></span>
				</div>
				<h3 style="margin-bottom: 5px;"><span>
<svg width="28" height="21" viewBox="0 0 28 21" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M24.6666 3.33325L9.99992 17.9999L3.33325 11.3333" stroke="#00ADA8" stroke-width="4" stroke-linecap="square"/>
...
</span>Компаниям сферы обслуживания</h3>
<div style="margin-left: 55px; margin-bottom: 20px;">
	
				
<span style="font-size:16px; color:#667399">например, салонам красоты, автомастерским, юридическим и нотариальным фирмам, транспортным организациям<br></span><br><br>
				</div>
				<h3 style="margin-bottom: 5px;"><span>
<svg width="28" height="21" viewBox="0 0 28 21" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M24.6666 3.33325L9.99992 17.9999L3.33325 11.3333" stroke="#00ADA8" stroke-width="4" stroke-linecap="square"/>
...
</span>Образовательным, научно-исследовательским учреждениям</h3>
<div style="margin-left: 55px; margin-bottom: 20px;">
	
				
<span style="font-size:16px; color:#667399">частным школам и садам, государственным и негосударственным университетам<br></span><br><br>
				</div>
				<h3 style="margin-bottom: 5px;"><span>
<svg width="28" height="21" viewBox="0 0 28 21" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M24.6666 3.33325L9.99992 17.9999L3.33325 11.3333" stroke="#00ADA8" stroke-width="4" stroke-linecap="square"/>
...
</span>Предприятиям общественного питания</h3>
<div style="margin-left: 55px; margin-bottom: 20px;">
	
				
<span style="font-size:16px; color:#667399">кафе, ресторанам, барам закусочным, бистро<br></span><br><br>
				</div>
			</div>
...
<section class="section__wrap grayback pb-1 pb-sm-5" style="background-color:white">
	<div class="container">
		...
		<div class="col-sm-12" style="text-align: center;">
                <h2>Особенности SEO-продвижения корпоративных сайтов</h2>
            </div>
		<div class="col-sm-4">
                    ...
                    <span style="font-size:24px">01</span>Фирменный стиль
                </span>
                    <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
                   Контент и дизайн сайтов должны быть уникальными и запоминающимися — это оценят и посетители, и поисковые системы. Содержание сайта требует чёткой стратегии и всесторонней проработки, чтобы укреплять экспертность и авторитет компании.
                    </span>
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">02</span>Юзабилити сайта
                </span>
                    
                  <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
                   На многостраничном корпоративном сайте придётся тщательно проработать структуру и позаботиться об удобстве использования. Посетитель должен быстро и без труда найти ответ на свой вопрос.
                    </span>
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">03</span>Контактные данные
                </span>

                    
                  <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
                    Чтобы потенциальные клиенты могли легко связаться с компанией, потребуется проработать страницу с контактами. В разделе должны быть номера телефонов, адреса электронной почты, формы обратной связи, а сотрудники должны быстро реагировать на эти обращения. Для большего доверия клиентов добавьте на страницу точные адреса компании и её филиалов и прикрепите карту со схемой проезда.
                    </span>
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">04</span>Сбор семантического ядра
                </span>


                    
                    <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
                    Сбор семантического ядра поможет выявить «боли» целевой  аудитории и определить варианты ключевых фраз.  Но нацеливаться стоит не только на ключевой товар, услугу или бренд, но и контролировать всю воронку продаж.
                    </span>
...
<span class="seo__banner1-title" style="color: black; font-size:20px">
                    <span style="font-size:24px">05</span>Совершенствование сайта
                </span>


                    
                    <span class="seo__banner1-text" style="color: black;  font-size:18px;padding-left: 45px;">
                    Корпоративный сайт нужно регулярно улучшать, совершенствовать, добавлять новый функционал и расширять семантическое ядро.
                    </span>
...
<div class="container">
    <div class="row">
        <div class="col-md-10" style="width:100%">
            <h2 style="text-align: center;">Зачем продвигать корпоративные сайты</h2>
...
<path d="M36.2197 49.4697L37.2803 50.5303L38.25 49.5605V50.75C38.25 51.1632 37.914 51.5 37.5 51.5H33C31.7595 51.5 30.75 52.5095 30.75 53.75V54.5758C29.0408 54.9245 27.75 56.4395 27.75 58.25C27.75 59.27 28.1618 60.194 28.8247 60.8705C26.8808 61.6407 25.5 63.5352 25.5 65.75V67.25C25.5 67.664 25.8353 68 26.25 68H36.75C37.1648 68 37.5 67.664 37.5 67.25V65.75C37.5 63.5352 36.1193 61.6407 34.1753 60.8705C34.8383 60.194 35.25 59.27 35.25 58.25C35.25 56.4395 33.9593 54.9245 32.25 54.5758V53.75C32.25 53.3368 32.586 53 33 53H37.5C38.7405 53 39.75 51.9905 39.75 50.75V49.5605L40.7197 50.5303L41.7803 49.4697L39.5303 47.2197C39.384 47.0735 39.192 47 39 47C38.808 47 38.616 47.0735 38.4697 47.2197L36.2197 49.4697ZM36 65.75V66.5H27V65.75C27 63.6823 28.6823 62 30.75 62H32.25C34.3177 62 36 63.6823 36 65.75ZM33.75 58.25C33.75 59.4905 32.7405 60.5 31.5 60.5C30.2595 60.5 29.25 59.4905 29.25 58.25C29.25 57.0095 30.2595 56 31.5 56C32.7405 56 33.75 57.0095 33.75 58.25Z" fill="white"/>
                   ...
                   С помощью рекламы и SEO можно своевременно информировать клиентов и партнёров об изменениях в работе, актуальных акциях или новинкам товаров и услуг.
                    </span>
</div>
                </div>
                <div class="advantage__item">
...
<path d="M49.5 53H51V54.5H49.5V53Z" fill="white"/>
                    ...
                    <span class="advantage__text1">
                   SEO обеспечивает продолжительный эффект, удерживая сайт на высоких позициях в поисковой выдаче и продолжая привлекать заинтересованных пользователь даже после завершения работ.
                    </span>
</div>
                </div>
                <div class="advantage__item">
...
<path d="M56.9978 50.0552C58.4812 50.0552 59.9312 49.6153 61.1646 48.7912C62.3979 47.9671 63.3592 46.7957 63.9269 45.4253C64.4946 44.0549 64.6431 42.5469 64.3537 41.092C64.0643 39.6371 63.35 38.3008 62.3011 37.2519C61.2522 36.203 59.9158 35.4887 58.461 35.1993C57.0061 34.9099 55.4981 35.0584 54.1277 35.6261C52.7572 36.1937 51.5859 37.155 50.7618 38.3884C49.9377 39.6218 49.4978 41.0718 49.4978 42.5552C49.5001 44.5436 50.291 46.45 51.697 47.856C53.103 49.262 55.0094 50.0529 56.9978 50.0552ZM56.9978 36.5552C58.1845 36.5552 59.3445 36.9071 60.3312 37.5664C61.3179 38.2256 62.087 39.1627 62.5411 40.2591C62.9952 41.3554 63.114 42.5618 62.8825 43.7257C62.651 44.8896 62.0796 45.9587 61.2404 46.7978C60.4013 47.6369 59.3322 48.2084 58.1683 48.4399C57.0045 48.6714 55.7981 48.5526 54.7017 48.0985C53.6053 47.6443 52.6683 46.8753 52.009 45.8886C51.3497 44.9019 50.9978 43.7419 50.9978 42.5552C50.9996 40.9644 51.6323 39.4394 52.7572 38.3145C53.882 37.1897 55.4071 36.557 56.9978 36.5552Z" fill="white"/>
                    ...
                    <span class="advantage__text1">
                Проработанный фирменный стиль и логичная структура продолжат влиять на конверсию сайта, провожая пользователей к целевому действию .
                    </span>
</div>
                </div>
...
<path d="M56.9978 50.0552C58.4812 50.0552 59.9312 49.6153 61.1646 48.7912C62.3979 47.9671 63.3592 46.7957 63.9269 45.4253C64.4946 44.0549 64.6431 42.5469 64.3537 41.092C64.0643 39.6371 63.35 38.3008 62.3011 37.2519C61.2522 36.203 59.9158 35.4887 58.461 35.1993C57.0061 34.9099 55.4981 35.0584 54.1277 35.6261C52.7572 36.1937 51.5859 37.155 50.7618 38.3884C49.9377 39.6218 49.4978 41.0718 49.4978 42.5552C49.5001 44.5436 50.291 46.45 51.697 47.856C53.103 49.262 55.0094 50.0529 56.9978 50.0552ZM56.9978 36.5552C58.1845 36.5552 59.3445 36.9071 60.3312 37.5664C61.3179 38.2256 62.087 39.1627 62.5411 40.2591C62.9952 41.3554 63.114 42.5618 62.8825 43.7257C62.651 44.8896 62.0796 45.9587 61.2404 46.7978C60.4013 47.6369 59.3322 48.2084 58.1683 48.4399C57.0045 48.6714 55.7981 48.5526 54.7017 48.0985C53.6053 47.6443 52.6683 46.8753 52.009 45.8886C51.3497 44.9019 50.9978 43.7419 50.9978 42.5552C50.9996 40.9644 51.6323 39.4394 52.7572 38.3145C53.882 37.1897 55.4071 36.557 56.9978 36.5552Z" fill="white"/>
                    ...
                    <span class="advantage__text1">
              Правильно выстроенная система обратной связи поможет оперативно получать реакцию клиентов на работу компании, благодаря чему можно своевременно внести корректировки в стратегию продвижения и развития.
                    </span>
</div>
                </div>
...
<path d="M56.9978 50.0552C58.4812 50.0552 59.9312 49.6153 61.1646 48.7912C62.3979 47.9671 63.3592 46.7957 63.9269 45.4253C64.4946 44.0549 64.6431 42.5469 64.3537 41.092C64.0643 39.6371 63.35 38.3008 62.3011 37.2519C61.2522 36.203 59.9158 35.4887 58.461 35.1993C57.0061 34.9099 55.4981 35.0584 54.1277 35.6261C52.7572 36.1937 51.5859 37.155 50.7618 38.3884C49.9377 39.6218 49.4978 41.0718 49.4978 42.5552C49.5001 44.5436 50.291 46.45 51.697 47.856C53.103 49.262 55.0094 50.0529 56.9978 50.0552ZM56.9978 36.5552C58.1845 36.5552 59.3445 36.9071 60.3312 37.5664C61.3179 38.2256 62.087 39.1627 62.5411 40.2591C62.9952 41.3554 63.114 42.5618 62.8825 43.7257C62.651 44.8896 62.0796 45.9587 61.2404 46.7978C60.4013 47.6369 59.3322 48.2084 58.1683 48.4399C57.0045 48.6714 55.7981 48.5526 54.7017 48.0985C53.6053 47.6443 52.6683 46.8753 52.009 45.8886C51.3497 44.9019 50.9978 43.7419 50.9978 42.5552C50.9996 40.9644 51.6323 39.4394 52.7572 38.3145C53.882 37.1897 55.4071 36.557 56.9978 36.5552Z" fill="white"/>
                    ...
                    <span class="advantage__text1">
             SEO повысит ключевой показатель эффективности продвижения — узнаваемость бренда, что приведёт к масштабированию бизнеса, росту продаж и среднего чека.
                    </span>
</div>
                </div>
        ...
        <div class="row">
			...
			<div style="margin-bottom: 40px">
				<span class="advantage__text1" style="color:white">
                  Точная сумма продвижения будет индивидуальна для каждого сайта. Она зависит от тематики сайта, количества регионов продвижения.
...
<section class="slider__wrap slider__seo">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <h2>Этапы продвижения корпоративного сайта</h2>
            </div>
            <div class="col-sm-12">
...
<section class="section__wrap grayback pb-1 pb-sm-5">
    <div class="container">
        ...
        <div class="row qa-elem">
            <div class="qa-title">
               Что даёт продвижение корпоративного сайта?
            </div>
            <div class="qa-content">
              Результаты поисковой оптимизации:
				<ul>
					<li>своевременная корректировка бизнес-целей с учётом быстрого темпа изменений рынка;</li>
<li>укрепление репутации бренда и повышение узнаваемости;</li>
<li>высокие позиции в поиске;</li>
<li>успешные результаты маркетинговой стратегии.</li>
				</ul>
            </div>
        </div>
		<div class="row qa-elem">
            <div class="qa-title">
               Какие существуют способы продвижения корпоративного сайта?
            </div>
            <div class="qa-content">
                Корпоративный сайт можно продвигать почти всеми доступными сейчас способами: SEO, контекстная, таргетированная или медийная реклама, динамические объявления на Поиске, рекламные размещения в блогах или СМИ, email-маркетинг и кросс-маркетинг и многие другие. 
            </div>
        </div>
		<div class="row qa-elem">
            <div class="qa-title">
            ...
            <div class="qa-content">
                Стоимость продвижения корпоративного сайта зависит от выбора модели ценообразования: по позициям, по трафику, по лидам. Кроме того, на цену влияет уровень конкуренции в нише бизнеса, выбранные запросы, регион, готовность сайта к продвижению и гарантии.
            </div>
        </div>
